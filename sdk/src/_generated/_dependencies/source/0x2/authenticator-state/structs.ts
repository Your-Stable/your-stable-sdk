...
export function isAuthenticatorState(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V34}::authenticator_state::AuthenticatorState`; }
...
export function isAuthenticatorStateInner(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V34}::authenticator_state::AuthenticatorStateInner`; }
...
export function isJWK(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V34}::authenticator_state::JWK`; }
...
export class JWK implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V34}::authenticator_state::JWK`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = JWK.$typeName; readonly $fullTypeName: `${typeof PKG_V34}::authenticator_state::JWK`; readonly $typeArgs: []; readonly $isPhantom = JWK.$isPhantom;

 readonly kty: ToField<String>; readonly e: ToField<String>; readonly n: ToField<String>; readonly alg: ToField<String>

 private constructor(typeArgs: [], fields: JWKFields, ) { this.$fullTypeName = composeSuiType( JWK.$typeName, ...typeArgs ) as `${typeof PKG_V34}::authenticator_state::JWK`; this.$typeArgs = typeArgs;

 this.kty = fields.kty;; this.e = fields.e;; this.n = fields.n;; this.alg = fields.alg; }

 static reified( ): JWKReified { return { typeName: JWK.$typeName, fullTypeName: composeSuiType( JWK.$typeName, ...[] ) as `${typeof PKG_V34}::authenticator_state::JWK`, typeArgs: [ ] as [], isPhantom: JWK.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => JWK.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => JWK.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => JWK.fromBcs( data, ), bcs: JWK.bcs, fromJSONField: (field: any) => JWK.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => JWK.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => JWK.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => JWK.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => JWK.fetch( client, id, ), new: ( fields: JWKFields, ) => { return new JWK( [], fields ) }, kind: "StructClassReified", } }
...
export function isJwkId(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V34}::authenticator_state::JwkId`; }
...
export class JwkId implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V34}::authenticator_state::JwkId`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = JwkId.$typeName; readonly $fullTypeName: `${typeof PKG_V34}::authenticator_state::JwkId`; readonly $typeArgs: []; readonly $isPhantom = JwkId.$isPhantom;

 readonly iss: ToField<String>; readonly kid: ToField<String>

 private constructor(typeArgs: [], fields: JwkIdFields, ) { this.$fullTypeName = composeSuiType( JwkId.$typeName, ...typeArgs ) as `${typeof PKG_V34}::authenticator_state::JwkId`; this.$typeArgs = typeArgs;

 this.iss = fields.iss;; this.kid = fields.kid; }

 static reified( ): JwkIdReified { return { typeName: JwkId.$typeName, fullTypeName: composeSuiType( JwkId.$typeName, ...[] ) as `${typeof PKG_V34}::authenticator_state::JwkId`, typeArgs: [ ] as [], isPhantom: JwkId.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => JwkId.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => JwkId.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => JwkId.fromBcs( data, ), bcs: JwkId.bcs, fromJSONField: (field: any) => JwkId.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => JwkId.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => JwkId.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => JwkId.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => JwkId.fetch( client, id, ), new: ( fields: JwkIdFields, ) => { return new JwkId( [], fields ) }, kind: "StructClassReified", } }
...
export function isActiveJwk(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V34}::authenticator_state::ActiveJwk`; }
