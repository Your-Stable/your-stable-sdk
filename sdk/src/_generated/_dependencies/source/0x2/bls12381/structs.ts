...
export function isScalar(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V35}::bls12381::Scalar`; }
...
export class Scalar implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V35}::bls12381::Scalar`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Scalar.$typeName; readonly $fullTypeName: `${typeof PKG_V35}::bls12381::Scalar`; readonly $typeArgs: []; readonly $isPhantom = Scalar.$isPhantom;

 readonly dummyField: ToField<"bool">

 private constructor(typeArgs: [], fields: ScalarFields, ) { this.$fullTypeName = composeSuiType( Scalar.$typeName, ...typeArgs ) as `${typeof PKG_V35}::bls12381::Scalar`; this.$typeArgs = typeArgs;

 this.dummyField = fields.dummyField; }

 static reified( ): ScalarReified { return { typeName: Scalar.$typeName, fullTypeName: composeSuiType( Scalar.$typeName, ...[] ) as `${typeof PKG_V35}::bls12381::Scalar`, typeArgs: [ ] as [], isPhantom: Scalar.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Scalar.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Scalar.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Scalar.fromBcs( data, ), bcs: Scalar.bcs, fromJSONField: (field: any) => Scalar.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Scalar.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Scalar.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Scalar.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Scalar.fetch( client, id, ), new: ( fields: ScalarFields, ) => { return new Scalar( [], fields ) }, kind: "StructClassReified", } }
...
export function isG1(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V35}::bls12381::G1`; }
...
export class G1 implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V35}::bls12381::G1`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = G1.$typeName; readonly $fullTypeName: `${typeof PKG_V35}::bls12381::G1`; readonly $typeArgs: []; readonly $isPhantom = G1.$isPhantom;

 readonly dummyField: ToField<"bool">

 private constructor(typeArgs: [], fields: G1Fields, ) { this.$fullTypeName = composeSuiType( G1.$typeName, ...typeArgs ) as `${typeof PKG_V35}::bls12381::G1`; this.$typeArgs = typeArgs;

 this.dummyField = fields.dummyField; }

 static reified( ): G1Reified { return { typeName: G1.$typeName, fullTypeName: composeSuiType( G1.$typeName, ...[] ) as `${typeof PKG_V35}::bls12381::G1`, typeArgs: [ ] as [], isPhantom: G1.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => G1.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => G1.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => G1.fromBcs( data, ), bcs: G1.bcs, fromJSONField: (field: any) => G1.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => G1.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => G1.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => G1.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => G1.fetch( client, id, ), new: ( fields: G1Fields, ) => { return new G1( [], fields ) }, kind: "StructClassReified", } }
...
export function isG2(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V35}::bls12381::G2`; }
...
export class G2 implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V35}::bls12381::G2`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = G2.$typeName; readonly $fullTypeName: `${typeof PKG_V35}::bls12381::G2`; readonly $typeArgs: []; readonly $isPhantom = G2.$isPhantom;

 readonly dummyField: ToField<"bool">

 private constructor(typeArgs: [], fields: G2Fields, ) { this.$fullTypeName = composeSuiType( G2.$typeName, ...typeArgs ) as `${typeof PKG_V35}::bls12381::G2`; this.$typeArgs = typeArgs;

 this.dummyField = fields.dummyField; }

 static reified( ): G2Reified { return { typeName: G2.$typeName, fullTypeName: composeSuiType( G2.$typeName, ...[] ) as `${typeof PKG_V35}::bls12381::G2`, typeArgs: [ ] as [], isPhantom: G2.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => G2.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => G2.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => G2.fromBcs( data, ), bcs: G2.bcs, fromJSONField: (field: any) => G2.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => G2.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => G2.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => G2.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => G2.fetch( client, id, ), new: ( fields: G2Fields, ) => { return new G2( [], fields ) }, kind: "StructClassReified", } }
...
export function isGT(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V35}::bls12381::GT`; }
...
export class GT implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V35}::bls12381::GT`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = GT.$typeName; readonly $fullTypeName: `${typeof PKG_V35}::bls12381::GT`; readonly $typeArgs: []; readonly $isPhantom = GT.$isPhantom;

 readonly dummyField: ToField<"bool">

 private constructor(typeArgs: [], fields: GTFields, ) { this.$fullTypeName = composeSuiType( GT.$typeName, ...typeArgs ) as `${typeof PKG_V35}::bls12381::GT`; this.$typeArgs = typeArgs;

 this.dummyField = fields.dummyField; }

 static reified( ): GTReified { return { typeName: GT.$typeName, fullTypeName: composeSuiType( GT.$typeName, ...[] ) as `${typeof PKG_V35}::bls12381::GT`, typeArgs: [ ] as [], isPhantom: GT.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => GT.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => GT.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => GT.fromBcs( data, ), bcs: GT.bcs, fromJSONField: (field: any) => GT.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => GT.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => GT.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => GT.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => GT.fetch( client, id, ), new: ( fields: GTFields, ) => { return new GT( [], fields ) }, kind: "StructClassReified", } }
...
export function isUncompressedG1(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V35}::bls12381::UncompressedG1`; }
...
export class UncompressedG1 implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V35}::bls12381::UncompressedG1`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = UncompressedG1.$typeName; readonly $fullTypeName: `${typeof PKG_V35}::bls12381::UncompressedG1`; readonly $typeArgs: []; readonly $isPhantom = UncompressedG1.$isPhantom;

 readonly dummyField: ToField<"bool">

 private constructor(typeArgs: [], fields: UncompressedG1Fields, ) { this.$fullTypeName = composeSuiType( UncompressedG1.$typeName, ...typeArgs ) as `${typeof PKG_V35}::bls12381::UncompressedG1`; this.$typeArgs = typeArgs;

 this.dummyField = fields.dummyField; }

 static reified( ): UncompressedG1Reified { return { typeName: UncompressedG1.$typeName, fullTypeName: composeSuiType( UncompressedG1.$typeName, ...[] ) as `${typeof PKG_V35}::bls12381::UncompressedG1`, typeArgs: [ ] as [], isPhantom: UncompressedG1.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => UncompressedG1.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => UncompressedG1.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => UncompressedG1.fromBcs( data, ), bcs: UncompressedG1.bcs, fromJSONField: (field: any) => UncompressedG1.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => UncompressedG1.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => UncompressedG1.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => UncompressedG1.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => UncompressedG1.fetch( client, id, ), new: ( fields: UncompressedG1Fields, ) => { return new UncompressedG1( [], fields ) }, kind: "StructClassReified", } }
