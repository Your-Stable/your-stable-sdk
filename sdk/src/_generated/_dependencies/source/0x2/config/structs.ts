import type {
  ...
  ToTypeArgument,
  ToTypeStr,
  TypeArgument} from "../../../../_framework/reified";
import {
...
export class Config<WriteCap extends PhantomTypeArgument>
  implements StructClass
{
  ...
  static reified<WriteCap extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        Config.fromSuiParsedData(WriteCap, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        Config.fromSuiObjectData(WriteCap, content),
      fetch: async (client: SuiClient, id: string) =>
        Config.fetch(client, WriteCap, id),
  ...
  static fromFieldsWithTypes<
    WriteCap extends PhantomReified<PhantomTypeArgument>,
  >(
    typeArg: WriteCap,
...
export class Setting<Value extends TypeArgument> implements StructClass {
  ...
  static reified<Value extends Reified<TypeArgument, any>>(
    ...
    return {
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        Setting.fromSuiParsedData(Value, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        Setting.fromSuiObjectData(Value, content),
      fetch: async (client: SuiClient, id: string) =>
        Setting.fetch(client, Value, id),
...
export class SettingData<Value extends TypeArgument> implements StructClass {
  ...
  private constructor(
    typeArgs: [ToTypeStr<Value>],
    fields: SettingDataFields<Value>,
  ) {
    this.$fullTypeName = composeSuiType(
  ...
  static reified<Value extends Reified<TypeArgument, any>>(
    ...
    return {
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        SettingData.fromSuiParsedData(Value, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        SettingData.fromSuiObjectData(Value, content),
      fetch: async (client: SuiClient, id: string) =>
        SettingData.fetch(client, Value, id),
