...
export function isCurve(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V35}::groth16::Curve`; }
...
export class Curve implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V35}::groth16::Curve`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Curve.$typeName; readonly $fullTypeName: `${typeof PKG_V35}::groth16::Curve`; readonly $typeArgs: []; readonly $isPhantom = Curve.$isPhantom;

 readonly id: ToField<"u8">

 private constructor(typeArgs: [], fields: CurveFields, ) { this.$fullTypeName = composeSuiType( Curve.$typeName, ...typeArgs ) as `${typeof PKG_V35}::groth16::Curve`; this.$typeArgs = typeArgs;

 this.id = fields.id; }

 static reified( ): CurveReified { return { typeName: Curve.$typeName, fullTypeName: composeSuiType( Curve.$typeName, ...[] ) as `${typeof PKG_V35}::groth16::Curve`, typeArgs: [ ] as [], isPhantom: Curve.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Curve.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Curve.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Curve.fromBcs( data, ), bcs: Curve.bcs, fromJSONField: (field: any) => Curve.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Curve.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Curve.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Curve.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Curve.fetch( client, id, ), new: ( fields: CurveFields, ) => { return new Curve( [], fields ) }, kind: "StructClassReified", } }
...
export function isPreparedVerifyingKey(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V35}::groth16::PreparedVerifyingKey`; }
...
export class PreparedVerifyingKey implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V35}::groth16::PreparedVerifyingKey`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = PreparedVerifyingKey.$typeName; readonly $fullTypeName: `${typeof PKG_V35}::groth16::PreparedVerifyingKey`; readonly $typeArgs: []; readonly $isPhantom = PreparedVerifyingKey.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: PreparedVerifyingKeyFields, ) { this.$fullTypeName = composeSuiType( PreparedVerifyingKey.$typeName, ...typeArgs ) as `${typeof PKG_V35}::groth16::PreparedVerifyingKey`; this.$typeArgs = typeArgs;
...
export function isPublicProofInputs(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V35}::groth16::PublicProofInputs`; }
...
export class PublicProofInputs implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V35}::groth16::PublicProofInputs`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = PublicProofInputs.$typeName; readonly $fullTypeName: `${typeof PKG_V35}::groth16::PublicProofInputs`; readonly $typeArgs: []; readonly $isPhantom = PublicProofInputs.$isPhantom;

 readonly bytes: ToField<Vector<"u8">>

 private constructor(typeArgs: [], fields: PublicProofInputsFields, ) { this.$fullTypeName = composeSuiType( PublicProofInputs.$typeName, ...typeArgs ) as `${typeof PKG_V35}::groth16::PublicProofInputs`; this.$typeArgs = typeArgs;

 this.bytes = fields.bytes; }

 static reified( ): PublicProofInputsReified { return { typeName: PublicProofInputs.$typeName, fullTypeName: composeSuiType( PublicProofInputs.$typeName, ...[] ) as `${typeof PKG_V35}::groth16::PublicProofInputs`, typeArgs: [ ] as [], isPhantom: PublicProofInputs.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => PublicProofInputs.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => PublicProofInputs.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => PublicProofInputs.fromBcs( data, ), bcs: PublicProofInputs.bcs, fromJSONField: (field: any) => PublicProofInputs.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => PublicProofInputs.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => PublicProofInputs.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => PublicProofInputs.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => PublicProofInputs.fetch( client, id, ), new: ( fields: PublicProofInputsFields, ) => { return new PublicProofInputs( [], fields ) }, kind: "StructClassReified", } }
...
export function isProofPoints(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V35}::groth16::ProofPoints`; }
...
export class ProofPoints implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V35}::groth16::ProofPoints`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = ProofPoints.$typeName; readonly $fullTypeName: `${typeof PKG_V35}::groth16::ProofPoints`; readonly $typeArgs: []; readonly $isPhantom = ProofPoints.$isPhantom;

 readonly bytes: ToField<Vector<"u8">>

 private constructor(typeArgs: [], fields: ProofPointsFields, ) { this.$fullTypeName = composeSuiType( ProofPoints.$typeName, ...typeArgs ) as `${typeof PKG_V35}::groth16::ProofPoints`; this.$typeArgs = typeArgs;

 this.bytes = fields.bytes; }

 static reified( ): ProofPointsReified { return { typeName: ProofPoints.$typeName, fullTypeName: composeSuiType( ProofPoints.$typeName, ...[] ) as `${typeof PKG_V35}::groth16::ProofPoints`, typeArgs: [ ] as [], isPhantom: ProofPoints.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => ProofPoints.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => ProofPoints.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => ProofPoints.fromBcs( data, ), bcs: ProofPoints.bcs, fromJSONField: (field: any) => ProofPoints.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => ProofPoints.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => ProofPoints.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => ProofPoints.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => ProofPoints.fetch( client, id, ), new: ( fields: ProofPointsFields, ) => { return new ProofPoints( [], fields ) }, kind: "StructClassReified", } }
