...
export function isKiosk(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V34}::kiosk::Kiosk`; }
...
export class Kiosk implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V34}::kiosk::Kiosk`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Kiosk.$typeName; readonly $fullTypeName: `${typeof PKG_V34}::kiosk::Kiosk`; readonly $typeArgs: []; readonly $isPhantom = Kiosk.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: KioskFields, ) { this.$fullTypeName = composeSuiType( Kiosk.$typeName, ...typeArgs ) as `${typeof PKG_V34}::kiosk::Kiosk`; this.$typeArgs = typeArgs;
...
export function isKioskOwnerCap(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V34}::kiosk::KioskOwnerCap`; }
...
export class KioskOwnerCap implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V34}::kiosk::KioskOwnerCap`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = KioskOwnerCap.$typeName; readonly $fullTypeName: `${typeof PKG_V34}::kiosk::KioskOwnerCap`; readonly $typeArgs: []; readonly $isPhantom = KioskOwnerCap.$isPhantom;

 readonly id: ToField<UID>; readonly for: ToField<ID>

 private constructor(typeArgs: [], fields: KioskOwnerCapFields, ) { this.$fullTypeName = composeSuiType( KioskOwnerCap.$typeName, ...typeArgs ) as `${typeof PKG_V34}::kiosk::KioskOwnerCap`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.for = fields.for; }

 static reified( ): KioskOwnerCapReified { return { typeName: KioskOwnerCap.$typeName, fullTypeName: composeSuiType( KioskOwnerCap.$typeName, ...[] ) as `${typeof PKG_V34}::kiosk::KioskOwnerCap`, typeArgs: [ ] as [], isPhantom: KioskOwnerCap.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => KioskOwnerCap.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => KioskOwnerCap.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => KioskOwnerCap.fromBcs( data, ), bcs: KioskOwnerCap.bcs, fromJSONField: (field: any) => KioskOwnerCap.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => KioskOwnerCap.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => KioskOwnerCap.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => KioskOwnerCap.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => KioskOwnerCap.fetch( client, id, ), new: ( fields: KioskOwnerCapFields, ) => { return new KioskOwnerCap( [], fields ) }, kind: "StructClassReified", } }
...
export function isPurchaseCap(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V34}::kiosk::PurchaseCap` + '<'); }
...
export function isBorrow(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V34}::kiosk::Borrow`; }
...
export function isItem(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V34}::kiosk::Item`; }
...
export class Item implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V34}::kiosk::Item`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Item.$typeName; readonly $fullTypeName: `${typeof PKG_V34}::kiosk::Item`; readonly $typeArgs: []; readonly $isPhantom = Item.$isPhantom;

 readonly id: ToField<ID>

 private constructor(typeArgs: [], fields: ItemFields, ) { this.$fullTypeName = composeSuiType( Item.$typeName, ...typeArgs ) as `${typeof PKG_V34}::kiosk::Item`; this.$typeArgs = typeArgs;

 this.id = fields.id; }

 static reified( ): ItemReified { return { typeName: Item.$typeName, fullTypeName: composeSuiType( Item.$typeName, ...[] ) as `${typeof PKG_V34}::kiosk::Item`, typeArgs: [ ] as [], isPhantom: Item.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Item.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Item.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Item.fromBcs( data, ), bcs: Item.bcs, fromJSONField: (field: any) => Item.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Item.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Item.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Item.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Item.fetch( client, id, ), new: ( fields: ItemFields, ) => { return new Item( [], fields ) }, kind: "StructClassReified", } }
...
export function isListing(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V34}::kiosk::Listing`; }
...
export class Listing implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V34}::kiosk::Listing`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Listing.$typeName; readonly $fullTypeName: `${typeof PKG_V34}::kiosk::Listing`; readonly $typeArgs: []; readonly $isPhantom = Listing.$isPhantom;

 readonly id: ToField<ID>; readonly isExclusive: ToField<"bool">

 private constructor(typeArgs: [], fields: ListingFields, ) { this.$fullTypeName = composeSuiType( Listing.$typeName, ...typeArgs ) as `${typeof PKG_V34}::kiosk::Listing`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.isExclusive = fields.isExclusive; }

 static reified( ): ListingReified { return { typeName: Listing.$typeName, fullTypeName: composeSuiType( Listing.$typeName, ...[] ) as `${typeof PKG_V34}::kiosk::Listing`, typeArgs: [ ] as [], isPhantom: Listing.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Listing.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Listing.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Listing.fromBcs( data, ), bcs: Listing.bcs, fromJSONField: (field: any) => Listing.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Listing.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Listing.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Listing.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Listing.fetch( client, id, ), new: ( fields: ListingFields, ) => { return new Listing( [], fields ) }, kind: "StructClassReified", } }
...
export function isLock(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V34}::kiosk::Lock`; }
...
export class Lock implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V34}::kiosk::Lock`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Lock.$typeName; readonly $fullTypeName: `${typeof PKG_V34}::kiosk::Lock`; readonly $typeArgs: []; readonly $isPhantom = Lock.$isPhantom;

 readonly id: ToField<ID>

 private constructor(typeArgs: [], fields: LockFields, ) { this.$fullTypeName = composeSuiType( Lock.$typeName, ...typeArgs ) as `${typeof PKG_V34}::kiosk::Lock`; this.$typeArgs = typeArgs;

 this.id = fields.id; }

 static reified( ): LockReified { return { typeName: Lock.$typeName, fullTypeName: composeSuiType( Lock.$typeName, ...[] ) as `${typeof PKG_V34}::kiosk::Lock`, typeArgs: [ ] as [], isPhantom: Lock.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Lock.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Lock.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Lock.fromBcs( data, ), bcs: Lock.bcs, fromJSONField: (field: any) => Lock.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Lock.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Lock.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Lock.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Lock.fetch( client, id, ), new: ( fields: LockFields, ) => { return new Lock( [], fields ) }, kind: "StructClassReified", } }
...
export function isItemListed(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V34}::kiosk::ItemListed` + '<'); }
...
export function isItemPurchased(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V34}::kiosk::ItemPurchased` + '<'); }
...
export function isItemDelisted(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V34}::kiosk::ItemDelisted` + '<'); }
...
export class ItemDelisted<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V34}::kiosk::ItemDelisted`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = ItemDelisted.$typeName; readonly $fullTypeName: `${typeof PKG_V34}::kiosk::ItemDelisted<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = ItemDelisted.$isPhantom;

 readonly kiosk: ToField<ID>; readonly id: ToField<ID>

 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: ItemDelistedFields<T>, ) { this.$fullTypeName = composeSuiType( ItemDelisted.$typeName, ...typeArgs ) as `${typeof PKG_V34}::kiosk::ItemDelisted<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;

 this.kiosk = fields.kiosk;; this.id = fields.id; }

 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): ItemDelistedReified<ToPhantomTypeArgument<T>> { return { typeName: ItemDelisted.$typeName, fullTypeName: composeSuiType( ItemDelisted.$typeName, ...[extractType(T)] ) as `${typeof PKG_V34}::kiosk::ItemDelisted<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: ItemDelisted.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => ItemDelisted.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => ItemDelisted.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => ItemDelisted.fromBcs( T, data, ), bcs: ItemDelisted.bcs, fromJSONField: (field: any) => ItemDelisted.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => ItemDelisted.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => ItemDelisted.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => ItemDelisted.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => ItemDelisted.fetch( client, T, id, ), new: ( fields: ItemDelistedFields<ToPhantomTypeArgument<T>>, ) => { return new ItemDelisted( [extractType(T)], fields ) }, kind: "StructClassReified", } }
