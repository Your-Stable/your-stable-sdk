...
export function isPublisher(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V34}::package::Publisher`; }
...
export class Publisher implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V34}::package::Publisher`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Publisher.$typeName; readonly $fullTypeName: `${typeof PKG_V34}::package::Publisher`; readonly $typeArgs: []; readonly $isPhantom = Publisher.$isPhantom;

 readonly id: ToField<UID>; readonly package: ToField<String>; readonly moduleName: ToField<String>

 private constructor(typeArgs: [], fields: PublisherFields, ) { this.$fullTypeName = composeSuiType( Publisher.$typeName, ...typeArgs ) as `${typeof PKG_V34}::package::Publisher`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.package = fields.package;; this.moduleName = fields.moduleName; }

 static reified( ): PublisherReified { return { typeName: Publisher.$typeName, fullTypeName: composeSuiType( Publisher.$typeName, ...[] ) as `${typeof PKG_V34}::package::Publisher`, typeArgs: [ ] as [], isPhantom: Publisher.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Publisher.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Publisher.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Publisher.fromBcs( data, ), bcs: Publisher.bcs, fromJSONField: (field: any) => Publisher.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Publisher.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Publisher.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Publisher.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Publisher.fetch( client, id, ), new: ( fields: PublisherFields, ) => { return new Publisher( [], fields ) }, kind: "StructClassReified", } }
...
export function isUpgradeCap(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V34}::package::UpgradeCap`; }
...
export class UpgradeCap implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V34}::package::UpgradeCap`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = UpgradeCap.$typeName; readonly $fullTypeName: `${typeof PKG_V34}::package::UpgradeCap`; readonly $typeArgs: []; readonly $isPhantom = UpgradeCap.$isPhantom;

 readonly id: ToField<UID>; readonly package: ToField<ID>; readonly version: ToField<"u64">; readonly policy: ToField<"u8">

 private constructor(typeArgs: [], fields: UpgradeCapFields, ) { this.$fullTypeName = composeSuiType( UpgradeCap.$typeName, ...typeArgs ) as `${typeof PKG_V34}::package::UpgradeCap`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.package = fields.package;; this.version = fields.version;; this.policy = fields.policy; }

 static reified( ): UpgradeCapReified { return { typeName: UpgradeCap.$typeName, fullTypeName: composeSuiType( UpgradeCap.$typeName, ...[] ) as `${typeof PKG_V34}::package::UpgradeCap`, typeArgs: [ ] as [], isPhantom: UpgradeCap.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => UpgradeCap.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => UpgradeCap.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => UpgradeCap.fromBcs( data, ), bcs: UpgradeCap.bcs, fromJSONField: (field: any) => UpgradeCap.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => UpgradeCap.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => UpgradeCap.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => UpgradeCap.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => UpgradeCap.fetch( client, id, ), new: ( fields: UpgradeCapFields, ) => { return new UpgradeCap( [], fields ) }, kind: "StructClassReified", } }
...
export function isUpgradeTicket(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V34}::package::UpgradeTicket`; }
...
export class UpgradeTicket implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V34}::package::UpgradeTicket`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = UpgradeTicket.$typeName; readonly $fullTypeName: `${typeof PKG_V34}::package::UpgradeTicket`; readonly $typeArgs: []; readonly $isPhantom = UpgradeTicket.$isPhantom;

 readonly cap: ToField<ID>; readonly package: ToField<ID>; readonly policy: ToField<"u8">; readonly digest: ToField<Vector<"u8">>

 private constructor(typeArgs: [], fields: UpgradeTicketFields, ) { this.$fullTypeName = composeSuiType( UpgradeTicket.$typeName, ...typeArgs ) as `${typeof PKG_V34}::package::UpgradeTicket`; this.$typeArgs = typeArgs;

 this.cap = fields.cap;; this.package = fields.package;; this.policy = fields.policy;; this.digest = fields.digest; }

 static reified( ): UpgradeTicketReified { return { typeName: UpgradeTicket.$typeName, fullTypeName: composeSuiType( UpgradeTicket.$typeName, ...[] ) as `${typeof PKG_V34}::package::UpgradeTicket`, typeArgs: [ ] as [], isPhantom: UpgradeTicket.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => UpgradeTicket.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => UpgradeTicket.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => UpgradeTicket.fromBcs( data, ), bcs: UpgradeTicket.bcs, fromJSONField: (field: any) => UpgradeTicket.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => UpgradeTicket.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => UpgradeTicket.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => UpgradeTicket.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => UpgradeTicket.fetch( client, id, ), new: ( fields: UpgradeTicketFields, ) => { return new UpgradeTicket( [], fields ) }, kind: "StructClassReified", } }
...
export function isUpgradeReceipt(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V34}::package::UpgradeReceipt`; }
