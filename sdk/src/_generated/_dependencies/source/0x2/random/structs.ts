...
export function isRandom(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V34}::random::Random`; }
...
export function isRandomInner(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V34}::random::RandomInner`; }
...
export class RandomInner implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V34}::random::RandomInner`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = RandomInner.$typeName; readonly $fullTypeName: `${typeof PKG_V34}::random::RandomInner`; readonly $typeArgs: []; readonly $isPhantom = RandomInner.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: RandomInnerFields, ) { this.$fullTypeName = composeSuiType( RandomInner.$typeName, ...typeArgs ) as `${typeof PKG_V34}::random::RandomInner`; this.$typeArgs = typeArgs;
 ...
 static reified( ): RandomInnerReified { return { typeName: RandomInner.$typeName, fullTypeName: composeSuiType( RandomInner.$typeName, ...[] ) as `${typeof PKG_V34}::random::RandomInner`, typeArgs: [ ] as [], isPhantom: RandomInner.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => RandomInner.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => RandomInner.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => RandomInner.fromBcs( data, ), bcs: RandomInner.bcs, fromJSONField: (field: any) => RandomInner.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => RandomInner.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => RandomInner.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => RandomInner.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => RandomInner.fetch( client, id, ), new: ( fields: RandomInnerFields, ) => { return new RandomInner( [], fields ) }, kind: "StructClassReified", } }
...
export function isRandomGenerator(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V34}::random::RandomGenerator`; }
...
export class RandomGenerator implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V34}::random::RandomGenerator`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = RandomGenerator.$typeName; readonly $fullTypeName: `${typeof PKG_V34}::random::RandomGenerator`; readonly $typeArgs: []; readonly $isPhantom = RandomGenerator.$isPhantom;

 readonly seed: ToField<Vector<"u8">>; readonly counter: ToField<"u16">; readonly buffer: ToField<Vector<"u8">>

 private constructor(typeArgs: [], fields: RandomGeneratorFields, ) { this.$fullTypeName = composeSuiType( RandomGenerator.$typeName, ...typeArgs ) as `${typeof PKG_V34}::random::RandomGenerator`; this.$typeArgs = typeArgs;

 this.seed = fields.seed;; this.counter = fields.counter;; this.buffer = fields.buffer; }

 static reified( ): RandomGeneratorReified { return { typeName: RandomGenerator.$typeName, fullTypeName: composeSuiType( RandomGenerator.$typeName, ...[] ) as `${typeof PKG_V34}::random::RandomGenerator`, typeArgs: [ ] as [], isPhantom: RandomGenerator.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => RandomGenerator.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => RandomGenerator.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => RandomGenerator.fromBcs( data, ), bcs: RandomGenerator.bcs, fromJSONField: (field: any) => RandomGenerator.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => RandomGenerator.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => RandomGenerator.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => RandomGenerator.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => RandomGenerator.fetch( client, id, ), new: ( fields: RandomGeneratorFields, ) => { return new RandomGenerator( [], fields ) }, kind: "StructClassReified", } }
