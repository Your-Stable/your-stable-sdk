...
export function isTransferRequest(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V35}::transfer_policy::TransferRequest` + '<'); }
...
export function isTransferPolicy(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V35}::transfer_policy::TransferPolicy` + '<'); }
...
export function isTransferPolicyCap(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V35}::transfer_policy::TransferPolicyCap` + '<'); }
...
export function isTransferPolicyCreated(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V35}::transfer_policy::TransferPolicyCreated` + '<'); }
...
export class TransferPolicyCreated<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V35}::transfer_policy::TransferPolicyCreated`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = TransferPolicyCreated.$typeName; readonly $fullTypeName: `${typeof PKG_V35}::transfer_policy::TransferPolicyCreated<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = TransferPolicyCreated.$isPhantom;

 readonly id: ToField<ID>

 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: TransferPolicyCreatedFields<T>, ) { this.$fullTypeName = composeSuiType( TransferPolicyCreated.$typeName, ...typeArgs ) as `${typeof PKG_V35}::transfer_policy::TransferPolicyCreated<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;

 this.id = fields.id; }

 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): TransferPolicyCreatedReified<ToPhantomTypeArgument<T>> { return { typeName: TransferPolicyCreated.$typeName, fullTypeName: composeSuiType( TransferPolicyCreated.$typeName, ...[extractType(T)] ) as `${typeof PKG_V35}::transfer_policy::TransferPolicyCreated<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: TransferPolicyCreated.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => TransferPolicyCreated.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => TransferPolicyCreated.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => TransferPolicyCreated.fromBcs( T, data, ), bcs: TransferPolicyCreated.bcs, fromJSONField: (field: any) => TransferPolicyCreated.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => TransferPolicyCreated.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => TransferPolicyCreated.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => TransferPolicyCreated.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => TransferPolicyCreated.fetch( client, T, id, ), new: ( fields: TransferPolicyCreatedFields<ToPhantomTypeArgument<T>>, ) => { return new TransferPolicyCreated( [extractType(T)], fields ) }, kind: "StructClassReified", } }
...
export function isTransferPolicyDestroyed(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V35}::transfer_policy::TransferPolicyDestroyed` + '<'); }
...
export class TransferPolicyDestroyed<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V35}::transfer_policy::TransferPolicyDestroyed`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = TransferPolicyDestroyed.$typeName; readonly $fullTypeName: `${typeof PKG_V35}::transfer_policy::TransferPolicyDestroyed<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = TransferPolicyDestroyed.$isPhantom;

 readonly id: ToField<ID>

 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: TransferPolicyDestroyedFields<T>, ) { this.$fullTypeName = composeSuiType( TransferPolicyDestroyed.$typeName, ...typeArgs ) as `${typeof PKG_V35}::transfer_policy::TransferPolicyDestroyed<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;

 this.id = fields.id; }

 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): TransferPolicyDestroyedReified<ToPhantomTypeArgument<T>> { return { typeName: TransferPolicyDestroyed.$typeName, fullTypeName: composeSuiType( TransferPolicyDestroyed.$typeName, ...[extractType(T)] ) as `${typeof PKG_V35}::transfer_policy::TransferPolicyDestroyed<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: TransferPolicyDestroyed.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => TransferPolicyDestroyed.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => TransferPolicyDestroyed.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => TransferPolicyDestroyed.fromBcs( T, data, ), bcs: TransferPolicyDestroyed.bcs, fromJSONField: (field: any) => TransferPolicyDestroyed.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => TransferPolicyDestroyed.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => TransferPolicyDestroyed.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => TransferPolicyDestroyed.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => TransferPolicyDestroyed.fetch( client, T, id, ), new: ( fields: TransferPolicyDestroyedFields<ToPhantomTypeArgument<T>>, ) => { return new TransferPolicyDestroyed( [extractType(T)], fields ) }, kind: "StructClassReified", } }
...
export function isRuleKey(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V35}::transfer_policy::RuleKey` + '<'); }
...
export class RuleKey<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V35}::transfer_policy::RuleKey`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = RuleKey.$typeName; readonly $fullTypeName: `${typeof PKG_V35}::transfer_policy::RuleKey<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = RuleKey.$isPhantom;

 readonly dummyField: ToField<"bool">

 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: RuleKeyFields<T>, ) { this.$fullTypeName = composeSuiType( RuleKey.$typeName, ...typeArgs ) as `${typeof PKG_V35}::transfer_policy::RuleKey<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;

 this.dummyField = fields.dummyField; }

 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): RuleKeyReified<ToPhantomTypeArgument<T>> { return { typeName: RuleKey.$typeName, fullTypeName: composeSuiType( RuleKey.$typeName, ...[extractType(T)] ) as `${typeof PKG_V35}::transfer_policy::RuleKey<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: RuleKey.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => RuleKey.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => RuleKey.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => RuleKey.fromBcs( T, data, ), bcs: RuleKey.bcs, fromJSONField: (field: any) => RuleKey.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => RuleKey.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => RuleKey.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => RuleKey.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => RuleKey.fetch( client, T, id, ), new: ( fields: RuleKeyFields<ToPhantomTypeArgument<T>>, ) => { return new RuleKey( [extractType(T)], fields ) }, kind: "StructClassReified", } }
