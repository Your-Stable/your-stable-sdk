...
export function isVersioned(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V35}::versioned::Versioned`; }
...
export function isVersionChangeCap(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V35}::versioned::VersionChangeCap`; }
