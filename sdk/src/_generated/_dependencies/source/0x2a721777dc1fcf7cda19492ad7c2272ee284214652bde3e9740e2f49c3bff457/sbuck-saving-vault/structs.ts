...
export function isAdminCap(type: string): boolean {
  ...
  return type === `${PKG_V1}::sbuck_saving_vault::AdminCap`;
}
...
export class AdminCap implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::sbuck_saving_vault::AdminCap`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = AdminCap.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::sbuck_saving_vault::AdminCap`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: AdminCapFields) {
    this.$fullTypeName = composeSuiType(
      AdminCap.$typeName,
      ...typeArgs,
    ) as `${typeof PKG_V1}::sbuck_saving_vault::AdminCap`;
...
export function isStrategy(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V1}::sbuck_saving_vault::Strategy`;
}
...
export interface StrategyFields {
  ...
  underlyingNominalValueBuck: ToField<"u64">;
  collectedProfitBuck: ToField<Balance<ToPhantom<BUCK>>>;
  collectedProfitSui: ToField<Balance<ToPhantom<SUI>>>;
  stakeProof: ToField<Option<StakeProof<ToPhantom<SBUCK>, ToPhantom<SUI>>>>;
}
...
export class Strategy implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::sbuck_saving_vault::Strategy`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = Strategy.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::sbuck_saving_vault::Strategy`;
  readonly $typeArgs: [];
  ...
  readonly underlyingNominalValueBuck: ToField<"u64">;
  readonly collectedProfitBuck: ToField<Balance<ToPhantom<BUCK>>>;
  readonly collectedProfitSui: ToField<Balance<ToPhantom<SUI>>>;
  readonly stakeProof: ToField<
    Option<StakeProof<ToPhantom<SBUCK>, ToPhantom<SUI>>>
  >;
  ...
  private constructor(typeArgs: [], fields: StrategyFields) {
    this.$fullTypeName = composeSuiType(
      Strategy.$typeName,
      ...typeArgs,
    ) as `${typeof PKG_V1}::sbuck_saving_vault::Strategy`;
    this.$typeArgs = typeArgs;
    ...
    this.underlyingNominalValueBuck = fields.underlyingNominalValueBuck;
    this.collectedProfitBuck = fields.collectedProfitBuck;
    this.collectedProfitSui = fields.collectedProfitSui;
    this.stakeProof = fields.stakeProof;
  }
  ...
  static reified(): StrategyReified {
    return {
      ...
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        Strategy.fromFieldsWithTypes(item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        Strategy.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        Strategy.fromSuiObjectData(content),
      fetch: async (client: SuiClient, id: string) =>
        Strategy.fetch(client, id),
  ...
  static get bcs() {
    return bcs.struct("Strategy", {
      ...
      underlying_nominal_value_buck: bcs.u64(),
      collected_profit_buck: Balance.bcs,
      collected_profit_sui: Balance.bcs,
      stake_proof: Option.bcs(StakeProof.bcs),
    });
  }
  ...
  static fromFields(fields: Record<string, any>): Strategy {
    return Strategy.reified().new({
      ...
      vaultAccess: decodeFromFields(
        Option.reified(VaultAccess.reified()),
        fields.vault_access,
      ),
      underlyingNominalValueBuck: decodeFromFields(
        "u64",
        fields.underlying_nominal_value_buck,
      ),
      collectedProfitBuck: decodeFromFields(
        Balance.reified(reified.phantom(BUCK.reified())),
        fields.collected_profit_buck,
      ),
      collectedProfitSui: decodeFromFields(
        Balance.reified(reified.phantom(SUI.reified())),
        fields.collected_profit_sui,
      ),
      stakeProof: decodeFromFields(
        Option.reified(
          StakeProof.reified(
            reified.phantom(SBUCK.reified()),
            reified.phantom(SUI.reified()),
          ),
        ),
        fields.stake_proof,
      ),
  ...
  static fromFieldsWithTypes(item: FieldsWithTypes): Strategy {
    ...
    return Strategy.reified().new({
      ...
      underlyingNominalValueBuck: decodeFromFieldsWithTypes(
        "u64",
        item.fields.underlying_nominal_value_buck,
      ),
      collectedProfitBuck: decodeFromFieldsWithTypes(
        Balance.reified(reified.phantom(BUCK.reified())),
        item.fields.collected_profit_buck,
      ),
      collectedProfitSui: decodeFromFieldsWithTypes(
        Balance.reified(reified.phantom(SUI.reified())),
        item.fields.collected_profit_sui,
      ),
      stakeProof: decodeFromFieldsWithTypes(
        Option.reified(
          StakeProof.reified(
            reified.phantom(SBUCK.reified()),
            reified.phantom(SUI.reified()),
  ...
  toJSONField() {
    return {
      ...
      underlyingNominalValueBuck: this.underlyingNominalValueBuck.toString(),
      collectedProfitBuck: this.collectedProfitBuck.toJSONField(),
      collectedProfitSui: this.collectedProfitSui.toJSONField(),
      stakeProof: fieldToJSON<
        Option<StakeProof<ToPhantom<SBUCK>, ToPhantom<SUI>>>
      >(
        `${Option.$typeName}<${StakeProof.$typeName}<${SBUCK.$typeName}, ${SUI.$typeName}>>`,
        this.stakeProof,
      ),
    };
  }
  ...
  static fromJSONField(field: any): Strategy {
    return Strategy.reified().new({
      ...
      vaultAccess: decodeFromJSONField(
        Option.reified(VaultAccess.reified()),
        field.vaultAccess,
      ),
      underlyingNominalValueBuck: decodeFromJSONField(
        "u64",
        field.underlyingNominalValueBuck,
      ),
      collectedProfitBuck: decodeFromJSONField(
        Balance.reified(reified.phantom(BUCK.reified())),
        field.collectedProfitBuck,
      ),
      collectedProfitSui: decodeFromJSONField(
        Balance.reified(reified.phantom(SUI.reified())),
        field.collectedProfitSui,
      ),
      stakeProof: decodeFromJSONField(
        Option.reified(
          StakeProof.reified(
            reified.phantom(SBUCK.reified()),
            reified.phantom(SUI.reified()),
  ...
  static fromSuiParsedData(content: SuiParsedData): Strategy {
    ...
    if (!isStrategy(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a Strategy object`,
      );
    }
  ...
  static async fetch(client: SuiClient, id: string): Promise<Strategy> {
    ...
    if (res.error) {
      throw new Error(
        `error fetching Strategy object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isStrategy(res.data.bcs.type)
    ) {
