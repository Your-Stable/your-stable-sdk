...
export function isDepositEvent(type: string): boolean {
  ...
  return type.startsWith(`${PKG_V1}::vault::DepositEvent` + "<");
}
...
export class DepositEvent<YT extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;

  static readonly $typeName = `${PKG_V1}::vault::DepositEvent`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = DepositEvent.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::vault::DepositEvent<${PhantomToTypeStr<YT>}>`;
  ...
  private constructor(
    ...
    fields: DepositEventFields<YT>,
  ) {
    this.$fullTypeName = composeSuiType(
      DepositEvent.$typeName,
      ...typeArgs,
    ) as `${typeof PKG_V1}::vault::DepositEvent<${PhantomToTypeStr<YT>}>`;
  ...
  static reified<YT extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        DepositEvent.$typeName,
        ...[extractType(YT)],
      ) as `${typeof PKG_V1}::vault::DepositEvent<${PhantomToTypeStr<ToPhantomTypeArgument<YT>>}>`,
      typeArgs: [extractType(YT)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<YT>>,
      ],
      isPhantom: DepositEvent.$isPhantom,
      reifiedTypeArgs: [YT],
      fromFields: (fields: Record<string, any>) =>
        DepositEvent.fromFields(YT, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        DepositEvent.fromFieldsWithTypes(YT, item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        DepositEvent.fromSuiParsedData(YT, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        DepositEvent.fromSuiObjectData(YT, content),
      fetch: async (client: SuiClient, id: string) =>
        DepositEvent.fetch(client, YT, id),
...
export function isWithdrawEvent(type: string): boolean {
  type = compressSuiType(type);
  return type.startsWith(`${PKG_V1}::vault::WithdrawEvent` + "<");
}
...
export class WithdrawEvent<YT extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;

  static readonly $typeName = `${PKG_V1}::vault::WithdrawEvent`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = WithdrawEvent.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::vault::WithdrawEvent<${PhantomToTypeStr<YT>}>`;
  readonly $typeArgs: [PhantomToTypeStr<YT>];
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<YT>],
    fields: WithdrawEventFields<YT>,
  ) {
    this.$fullTypeName = composeSuiType(
      WithdrawEvent.$typeName,
      ...typeArgs,
    ) as `${typeof PKG_V1}::vault::WithdrawEvent<${PhantomToTypeStr<YT>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<YT extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        WithdrawEvent.$typeName,
        ...[extractType(YT)],
      ) as `${typeof PKG_V1}::vault::WithdrawEvent<${PhantomToTypeStr<ToPhantomTypeArgument<YT>>}>`,
      typeArgs: [extractType(YT)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<YT>>,
      ],
      ...
      reifiedTypeArgs: [YT],
      fromFields: (fields: Record<string, any>) =>
        WithdrawEvent.fromFields(YT, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        WithdrawEvent.fromFieldsWithTypes(YT, item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        WithdrawEvent.fromSuiParsedData(YT, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        WithdrawEvent.fromSuiObjectData(YT, content),
      fetch: async (client: SuiClient, id: string) =>
        WithdrawEvent.fetch(client, YT, id),
...
export function isStrategyProfitEvent(type: string): boolean {
  type = compressSuiType(type);
  return type.startsWith(`${PKG_V1}::vault::StrategyProfitEvent` + "<");
}
...
export type StrategyProfitEventReified<YT extends PhantomTypeArgument> =
  Reified<StrategyProfitEvent<YT>, StrategyProfitEventFields<YT>>;

export class StrategyProfitEvent<YT extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;

  static readonly $typeName = `${PKG_V1}::vault::StrategyProfitEvent`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = StrategyProfitEvent.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::vault::StrategyProfitEvent<${PhantomToTypeStr<YT>}>`;
  readonly $typeArgs: [PhantomToTypeStr<YT>];
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<YT>],
    fields: StrategyProfitEventFields<YT>,
  ) {
    this.$fullTypeName = composeSuiType(
      StrategyProfitEvent.$typeName,
      ...typeArgs,
    ) as `${typeof PKG_V1}::vault::StrategyProfitEvent<${PhantomToTypeStr<YT>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<YT extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        StrategyProfitEvent.$typeName,
        ...[extractType(YT)],
      ) as `${typeof PKG_V1}::vault::StrategyProfitEvent<${PhantomToTypeStr<ToPhantomTypeArgument<YT>>}>`,
      typeArgs: [extractType(YT)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<YT>>,
      ],
      ...
      reifiedTypeArgs: [YT],
      fromFields: (fields: Record<string, any>) =>
        StrategyProfitEvent.fromFields(YT, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
      ...
      fromJSONField: (field: any) =>
        StrategyProfitEvent.fromJSONField(YT, field),
      fromJSON: (json: Record<string, any>) =>
        StrategyProfitEvent.fromJSON(YT, json),
      fromSuiParsedData: (content: SuiParsedData) =>
...
export function isStrategyBaseProfitEvent(type: string): boolean {
  type = compressSuiType(type);
  return type.startsWith(`${PKG_V1}::vault::StrategyBaseProfitEvent` + "<");
}

export interface StrategyBaseProfitEventFields<T extends PhantomTypeArgument> {
  strategyId: ToField<ID>;
  profit: ToField<"u64">;
  baseFee: ToField<"u64">;
}

export type StrategyBaseProfitEventReified<T extends PhantomTypeArgument> =
  Reified<StrategyBaseProfitEvent<T>, StrategyBaseProfitEventFields<T>>;

export class StrategyBaseProfitEvent<T extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;

  static readonly $typeName = `${PKG_V1}::vault::StrategyBaseProfitEvent`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = StrategyBaseProfitEvent.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::vault::StrategyBaseProfitEvent<${PhantomToTypeStr<T>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T>];
  readonly $isPhantom = StrategyBaseProfitEvent.$isPhantom;

  readonly strategyId: ToField<ID>;
  readonly profit: ToField<"u64">;
  readonly baseFee: ToField<"u64">;

  private constructor(
    typeArgs: [PhantomToTypeStr<T>],
    fields: StrategyBaseProfitEventFields<T>,
  ) {
    this.$fullTypeName = composeSuiType(
      StrategyBaseProfitEvent.$typeName,
      ...typeArgs,
    ) as `${typeof PKG_V1}::vault::StrategyBaseProfitEvent<${PhantomToTypeStr<T>}>`;
    this.$typeArgs = typeArgs;

    this.strategyId = fields.strategyId;
    this.profit = fields.profit;
    this.baseFee = fields.baseFee;
  }

  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    T: T,
  ): StrategyBaseProfitEventReified<ToPhantomTypeArgument<T>> {
    return {
      typeName: StrategyBaseProfitEvent.$typeName,
      fullTypeName: composeSuiType(
        StrategyBaseProfitEvent.$typeName,
        ...[extractType(T)],
      ) as `${typeof PKG_V1}::vault::StrategyBaseProfitEvent<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
      typeArgs: [extractType(T)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T>>,
      ],
      isPhantom: StrategyBaseProfitEvent.$isPhantom,
      reifiedTypeArgs: [T],
      fromFields: (fields: Record<string, any>) =>
        StrategyBaseProfitEvent.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        StrategyBaseProfitEvent.fromFieldsWithTypes(T, item),
      fromBcs: (data: Uint8Array) => StrategyBaseProfitEvent.fromBcs(T, data),
      bcs: StrategyBaseProfitEvent.bcs,
      fromJSONField: (field: any) =>
        StrategyBaseProfitEvent.fromJSONField(T, field),
      fromJSON: (json: Record<string, any>) =>
        StrategyBaseProfitEvent.fromJSON(T, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        StrategyBaseProfitEvent.fromSuiParsedData(T, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        StrategyBaseProfitEvent.fromSuiObjectData(T, content),
      fetch: async (client: SuiClient, id: string) =>
        StrategyBaseProfitEvent.fetch(client, T, id),
      new: (
        fields: StrategyBaseProfitEventFields<ToPhantomTypeArgument<T>>,
      ) => {
        return new StrategyBaseProfitEvent([extractType(T)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static get r() {
    return StrategyBaseProfitEvent.reified;
  }

  static phantom<T extends PhantomReified<PhantomTypeArgument>>(
    T: T,
  ): PhantomReified<
    ToTypeStr<StrategyBaseProfitEvent<ToPhantomTypeArgument<T>>>
  > {
    return phantom(StrategyBaseProfitEvent.reified(T));
  }
  static get p() {
    return StrategyBaseProfitEvent.phantom;
  }

  static get bcs() {
    return bcs.struct("StrategyBaseProfitEvent", {
      strategy_id: ID.bcs,
      profit: bcs.u64(),
      base_fee: bcs.u64(),
    });
  ...
  static fromFields<T extends PhantomReified<PhantomTypeArgument>>(
    typeArg: T,
    fields: Record<string, any>,
  ): StrategyBaseProfitEvent<ToPhantomTypeArgument<T>> {
    return StrategyBaseProfitEvent.reified(typeArg).new({
      strategyId: decodeFromFields(ID.reified(), fields.strategy_id),
      profit: decodeFromFields("u64", fields.profit),
      baseFee: decodeFromFields("u64", fields.base_fee),
    });
  }
  ...
  static fromFieldsWithTypes<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isStrategyBaseProfitEvent(item.type)) {
      throw new Error("not a StrategyBaseProfitEvent type");
    }
    assertFieldsWithTypesArgsMatch(item, [typeArg]);
    ...
    return StrategyBaseProfitEvent.reified(typeArg).new({
      ...
      profit: decodeFromFieldsWithTypes("u64", item.fields.profit),
      baseFee: decodeFromFieldsWithTypes("u64", item.fields.base_fee),
    });
  }
  ...
  static fromBcs<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return StrategyBaseProfitEvent.fromFields(
      typeArg,
      StrategyBaseProfitEvent.bcs.parse(data),
    );
  }
  ...
  static fromJSONField<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return StrategyBaseProfitEvent.reified(typeArg).new({
      strategyId: decodeFromJSONField(ID.reified(), field.strategyId),
      profit: decodeFromJSONField("u64", field.profit),
      baseFee: decodeFromJSONField("u64", field.baseFee),
    });
  }
  ...
  static fromJSON<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (json.$typeName !== StrategyBaseProfitEvent.$typeName) {
      throw new Error("not a WithTwoGenerics json object");
    }
    assertReifiedTypeArgsMatch(
      composeSuiType(StrategyBaseProfitEvent.$typeName, extractType(typeArg)),
      json.$typeArgs,
      [typeArg],
    );
  ...
  static fromSuiParsedData<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isStrategyBaseProfitEvent(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a StrategyBaseProfitEvent object`,
      );
    }
    return StrategyBaseProfitEvent.fromFieldsWithTypes(typeArg, content);
  }
  ...
  static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isStrategyBaseProfitEvent(data.bcs.type)
      ) {
        throw new Error(`object at is not a StrategyBaseProfitEvent object`);
      }
      ...
      return StrategyBaseProfitEvent.fromBcs(
        typeArg,
        fromB64(data.bcs.bcsBytes),
      );
    }
    if (data.content) {
      return StrategyBaseProfitEvent.fromSuiParsedData(typeArg, data.content);
    }
    throw new Error(
      "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.",
    );
  ...
  static async fetch<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T,
    id: string,
  ): Promise<StrategyBaseProfitEvent<ToPhantomTypeArgument<T>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching StrategyBaseProfitEvent object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isStrategyBaseProfitEvent(res.data.bcs.type)
    ) {
      throw new Error(
        `object at id ${id} is not a StrategyBaseProfitEvent object`,
      );
    }
...
export function isStrategyLossEvent(type: string): boolean {
  type = compressSuiType(type);
  return type.startsWith(`${PKG_V1}::vault::StrategyLossEvent` + "<");
}
...
export class StrategyLossEvent<YT extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;

  static readonly $typeName = `${PKG_V1}::vault::StrategyLossEvent`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = StrategyLossEvent.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::vault::StrategyLossEvent<${PhantomToTypeStr<YT>}>`;
  readonly $typeArgs: [PhantomToTypeStr<YT>];
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<YT>],
    fields: StrategyLossEventFields<YT>,
  ) {
    this.$fullTypeName = composeSuiType(
      StrategyLossEvent.$typeName,
      ...typeArgs,
    ) as `${typeof PKG_V1}::vault::StrategyLossEvent<${PhantomToTypeStr<YT>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<YT extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fullTypeName: composeSuiType(
        StrategyLossEvent.$typeName,
        ...[extractType(YT)],
      ) as `${typeof PKG_V1}::vault::StrategyLossEvent<${PhantomToTypeStr<ToPhantomTypeArgument<YT>>}>`,
      typeArgs: [extractType(YT)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<YT>>,
      ],
      ...
      reifiedTypeArgs: [YT],
      fromFields: (fields: Record<string, any>) =>
        StrategyLossEvent.fromFields(YT, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
      ...
      fromJSON: (json: Record<string, any>) =>
        StrategyLossEvent.fromJSON(YT, json),
      fromSuiParsedData: (content: SuiParsedData) =>
...
export class AdminCap<YT extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<YT extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      reifiedTypeArgs: [YT],
      fromFields: (fields: Record<string, any>) =>
        AdminCap.fromFields(YT, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        AdminCap.fromFieldsWithTypes(YT, item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        AdminCap.fromSuiParsedData(YT, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        AdminCap.fromSuiObjectData(YT, content),
      fetch: async (client: SuiClient, id: string) =>
        AdminCap.fetch(client, YT, id),
...
export class VaultAccess implements StructClass {
  ...
  static reified(): VaultAccessReified {
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        VaultAccess.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        VaultAccess.fromFieldsWithTypes(item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        VaultAccess.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        VaultAccess.fromSuiObjectData(content),
      fetch: async (client: SuiClient, id: string) =>
        VaultAccess.fetch(client, id),
  ...
  static fromSuiParsedData(content: SuiParsedData): VaultAccess {
    ...
    if (!isVaultAccess(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a VaultAccess object`,
      );
    }
  ...
  static async fetch(client: SuiClient, id: string): Promise<VaultAccess> {
    ...
    if (res.error) {
      throw new Error(
        `error fetching VaultAccess object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isVaultAccess(res.data.bcs.type)
    ) {
...
export class StrategyRemovalTicket<
  T extends PhantomTypeArgument,
  YT extends PhantomTypeArgument,
> implements StructClass
{
  ...
  >(
    T: T,
    YT: YT,
  ): StrategyRemovalTicketReified<
    ToPhantomTypeArgument<T>,
    ToPhantomTypeArgument<YT>
  > {
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        StrategyRemovalTicket.fromBcs([T, YT], data),
      bcs: StrategyRemovalTicket.bcs,
      fromJSONField: (field: any) =>
        StrategyRemovalTicket.fromJSONField([T, YT], field),
      fromJSON: (json: Record<string, any>) =>
        StrategyRemovalTicket.fromJSON([T, YT], json),
      fromSuiParsedData: (content: SuiParsedData) =>
      ...
      new: (
        fields: StrategyRemovalTicketFields<
          ToPhantomTypeArgument<T>,
          ToPhantomTypeArgument<YT>
        >,
      ) => {
        return new StrategyRemovalTicket(
          [extractType(T), extractType(YT)],
          fields,
        );
      },
  ...
  > {
    return StrategyRemovalTicket.reified(typeArgs[0], typeArgs[1]).new({
      ...
      returnedBalance: decodeFromFields(
        Balance.reified(typeArgs[0]),
        fields.returned_balance,
      ),
    });
  }
  ...
  > {
    ...
    return StrategyRemovalTicket.reified(typeArgs[0], typeArgs[1]).new({
      access: decodeFromFieldsWithTypes(
        VaultAccess.reified(),
        item.fields.access,
      ),
  ...
  >(
    ...
    ToPhantomTypeArgument<YT>
  > {
    return StrategyRemovalTicket.fromFields(
      typeArgs,
      StrategyRemovalTicket.bcs.parse(data),
    );
  }
  ...
  > {
    return StrategyRemovalTicket.reified(typeArgs[0], typeArgs[1]).new({
      ...
      returnedBalance: decodeFromJSONField(
        Balance.reified(typeArgs[0]),
        field.returnedBalance,
      ),
    });
  }
  ...
  > {
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isStrategyRemovalTicket(data.bcs.type)
      ) {
      ...
      return StrategyRemovalTicket.fromBcs(
        typeArgs,
        fromB64(data.bcs.bcsBytes),
      );
    }
  ...
  > {
    ...
    if (res.error) {
      throw new Error(
        `error fetching StrategyRemovalTicket object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isStrategyRemovalTicket(res.data.bcs.type)
    ) {
      throw new Error(
        `object at id ${id} is not a StrategyRemovalTicket object`,
      );
    }
...
export type StrategyWithdrawInfoReified<T extends PhantomTypeArgument> =
  Reified<StrategyWithdrawInfo<T>, StrategyWithdrawInfoFields<T>>;

export class StrategyWithdrawInfo<T extends PhantomTypeArgument>
  implements StructClass
{
  __StructClass = true as const;
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T>],
    fields: StrategyWithdrawInfoFields<T>,
  ) {
    this.$fullTypeName = composeSuiType(
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      reifiedTypeArgs: [T],
      fromFields: (fields: Record<string, any>) =>
        StrategyWithdrawInfo.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
      ...
      fromJSONField: (field: any) =>
        StrategyWithdrawInfo.fromJSONField(T, field),
      fromJSON: (json: Record<string, any>) =>
        StrategyWithdrawInfo.fromJSON(T, json),
      fromSuiParsedData: (content: SuiParsedData) =>
  ...
  static fromFields<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return StrategyWithdrawInfo.reified(typeArg).new({
      toWithdraw: decodeFromFields("u64", fields.to_withdraw),
      withdrawnBalance: decodeFromFields(
        Balance.reified(typeArg),
        fields.withdrawn_balance,
      ),
  ...
  static fromFieldsWithTypes<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return StrategyWithdrawInfo.reified(typeArg).new({
      ...
      hasWithdrawn: decodeFromFieldsWithTypes(
        "bool",
        item.fields.has_withdrawn,
      ),
    });
  }
  ...
  static fromBcs<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return StrategyWithdrawInfo.fromFields(
      typeArg,
      StrategyWithdrawInfo.bcs.parse(data),
    );
  }
  ...
  static fromJSONField<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return StrategyWithdrawInfo.reified(typeArg).new({
      toWithdraw: decodeFromJSONField("u64", field.toWithdraw),
      withdrawnBalance: decodeFromJSONField(
        Balance.reified(typeArg),
        field.withdrawnBalance,
      ),
  ...
  static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isStrategyWithdrawInfo(data.bcs.type)
      ) {
  ...
  static async fetch<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (res.error) {
      throw new Error(
        `error fetching StrategyWithdrawInfo object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isStrategyWithdrawInfo(res.data.bcs.type)
    ) {
      throw new Error(
        `object at id ${id} is not a StrategyWithdrawInfo object`,
      );
    }
...
> implements StructClass
{
  ...
  > {
    return {
      ...
      reifiedTypeArgs: [T, YT],
      fromFields: (fields: Record<string, any>) =>
        WithdrawTicket.fromFields([T, YT], fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
      ...
      fromJSONField: (field: any) =>
        WithdrawTicket.fromJSONField([T, YT], field),
      fromJSON: (json: Record<string, any>) =>
        WithdrawTicket.fromJSON([T, YT], json),
      fromSuiParsedData: (content: SuiParsedData) =>
  ...
  >(
    ...
    return WithdrawTicket.reified(typeArgs[0], typeArgs[1]).new({
      ...
      lpToBurn: decodeFromFieldsWithTypes(
        Balance.reified(typeArgs[1]),
        item.fields.lp_to_burn,
      ),
    });
  }
  ...
  >(
    ...
    return WithdrawTicket.reified(typeArgs[0], typeArgs[1]).new({
      toWithdrawFromFreeBalance: decodeFromJSONField(
        "u64",
        field.toWithdrawFromFreeBalance,
      ),
      strategyInfos: decodeFromJSONField(
        VecMap.reified(ID.reified(), StrategyWithdrawInfo.reified(typeArgs[0])),
        field.strategyInfos,
      ),
      lpToBurn: decodeFromJSONField(
        Balance.reified(typeArgs[1]),
        field.lpToBurn,
      ),
    });
  ...
  >(
    ...
    if (!isWithdrawTicket(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a WithdrawTicket object`,
      );
    }
  ...
  >(
    ...
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isWithdrawTicket(data.bcs.type)
      ) {
  ...
  > {
    ...
    if (res.error) {
      throw new Error(
        `error fetching WithdrawTicket object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isWithdrawTicket(res.data.bcs.type)
    ) {
...
export class RebalanceInfo implements StructClass {
  ...
  static reified(): RebalanceInfoReified {
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        RebalanceInfo.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        RebalanceInfo.fromFieldsWithTypes(item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        RebalanceInfo.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        RebalanceInfo.fromSuiObjectData(content),
      fetch: async (client: SuiClient, id: string) =>
        RebalanceInfo.fetch(client, id),
  ...
  static fromSuiParsedData(content: SuiParsedData): RebalanceInfo {
    ...
    if (!isRebalanceInfo(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a RebalanceInfo object`,
      );
    }
  ...
  static async fetch(client: SuiClient, id: string): Promise<RebalanceInfo> {
    ...
    if (res.error) {
      throw new Error(
        `error fetching RebalanceInfo object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isRebalanceInfo(res.data.bcs.type)
    ) {
...
export type RebalanceAmountsReified = Reified<
  RebalanceAmounts,
  RebalanceAmountsFields
>;
...
export class RebalanceAmounts implements StructClass {
  ...
  static reified(): RebalanceAmountsReified {
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        RebalanceAmounts.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        RebalanceAmounts.fromFieldsWithTypes(item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        RebalanceAmounts.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        RebalanceAmounts.fromSuiObjectData(content),
      fetch: async (client: SuiClient, id: string) =>
        RebalanceAmounts.fetch(client, id),
  ...
  static fromSuiParsedData(content: SuiParsedData): RebalanceAmounts {
    ...
    if (!isRebalanceAmounts(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a RebalanceAmounts object`,
      );
    }
  ...
  static fromSuiObjectData(data: SuiObjectData): RebalanceAmounts {
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isRebalanceAmounts(data.bcs.type)
      ) {
  ...
  static async fetch(client: SuiClient, id: string): Promise<RebalanceAmounts> {
    ...
    if (res.error) {
      throw new Error(
        `error fetching RebalanceAmounts object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isRebalanceAmounts(res.data.bcs.type)
    ) {
...
export class StrategyState implements StructClass {
  ...
  static reified(): StrategyStateReified {
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        StrategyState.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        StrategyState.fromFieldsWithTypes(item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        StrategyState.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        StrategyState.fromSuiObjectData(content),
      fetch: async (client: SuiClient, id: string) =>
        StrategyState.fetch(client, id),
  ...
  static fromFields(fields: Record<string, any>): StrategyState {
    return StrategyState.reified().new({
      ...
      targetAllocWeightBps: decodeFromFields(
        "u64",
        fields.target_alloc_weight_bps,
      ),
  ...
  static fromFieldsWithTypes(item: FieldsWithTypes): StrategyState {
    ...
    return StrategyState.reified().new({
      ...
      targetAllocWeightBps: decodeFromFieldsWithTypes(
        "u64",
        item.fields.target_alloc_weight_bps,
      ),
      maxBorrow: decodeFromFieldsWithTypes(
        Option.reified("u64"),
        item.fields.max_borrow,
      ),
    });
  }
  ...
  toJSONField() {
    return {
      ...
      maxBorrow: fieldToJSON<Option<"u64">>(
        `${Option.$typeName}<u64>`,
        this.maxBorrow,
      ),
    };
  ...
  static fromJSONField(field: any): StrategyState {
    return StrategyState.reified().new({
      ...
      targetAllocWeightBps: decodeFromJSONField(
        "u64",
        field.targetAllocWeightBps,
      ),
  ...
  static fromSuiParsedData(content: SuiParsedData): StrategyState {
    ...
    if (!isStrategyState(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a StrategyState object`,
      );
    }
  ...
  static async fetch(client: SuiClient, id: string): Promise<StrategyState> {
    ...
    if (res.error) {
      throw new Error(
        `error fetching StrategyState object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isStrategyState(res.data.bcs.type)
    ) {
...
export type VaultReified<
  T extends PhantomTypeArgument,
  YT extends PhantomTypeArgument,
> = Reified<Vault<T, YT>, VaultFields<T, YT>>;
...
> implements StructClass
{
  ...
  >(
    ...
    return {
      ...
      reifiedTypeArgs: [T, YT],
      fromFields: (fields: Record<string, any>) =>
        Vault.fromFields([T, YT], fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        Vault.fromFieldsWithTypes([T, YT], item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        Vault.fromSuiParsedData([T, YT], content),
      fromSuiObjectData: (content: SuiObjectData) =>
        Vault.fromSuiObjectData([T, YT], content),
      fetch: async (client: SuiClient, id: string) =>
        Vault.fetch(client, [T, YT], id),
      new: (
        fields: VaultFields<
          ToPhantomTypeArgument<T>,
          ToPhantomTypeArgument<YT>
  ...
  >(
    ...
    ToTypeStr<Vault<ToPhantomTypeArgument<T>, ToPhantomTypeArgument<YT>>>
  > {
  ...
  >(
    ...
    return Vault.reified(typeArgs[0], typeArgs[1]).new({
      ...
      withdrawTicketIssued: decodeFromFields(
        "bool",
        fields.withdraw_ticket_issued,
      ),
      tvlCap: decodeFromFields(Option.reified("u64"), fields.tvl_cap),
      profitUnlockDurationSec: decodeFromFields(
        "u64",
        fields.profit_unlock_duration_sec,
      ),
  ...
  >(
    ...
    return Vault.reified(typeArgs[0], typeArgs[1]).new({
      ...
      withdrawTicketIssued: decodeFromFieldsWithTypes(
        "bool",
        item.fields.withdraw_ticket_issued,
      ),
      tvlCap: decodeFromFieldsWithTypes(
        Option.reified("u64"),
        item.fields.tvl_cap,
      ),
      ...
      performanceFeeBps: decodeFromFieldsWithTypes(
        "u64",
        item.fields.performance_fee_bps,
      ),
  ...
  >(
    ...
    return Vault.reified(typeArgs[0], typeArgs[1]).new({
      id: decodeFromJSONField(UID.reified(), field.id),
      freeBalance: decodeFromJSONField(
        Balance.reified(typeArgs[0]),
        field.freeBalance,
      ),
      ...
      lpTreasury: decodeFromJSONField(
        TreasuryCap.reified(typeArgs[1]),
        field.lpTreasury,
      ),
      ...
      withdrawTicketIssued: decodeFromJSONField(
        "bool",
        field.withdrawTicketIssued,
      ),
      tvlCap: decodeFromJSONField(Option.reified("u64"), field.tvlCap),
      profitUnlockDurationSec: decodeFromJSONField(
        "u64",
        field.profitUnlockDurationSec,
      ),
  ...
  >(
    ...
    if (!isVault(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a Vault object`,
      );
    }
  ...
  >(
    ...
    if (res.error) {
      throw new Error(
        `error fetching Vault object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isVault(res.data.bcs.type)
    ) {
...
export function isBalanceKey(type: string): boolean {
  type = compressSuiType(type);
  return type.startsWith(`${PKG_V1}::vault::BalanceKey` + "<");
}

export interface BalanceKeyFields<T extends PhantomTypeArgument> {
  dummyField: ToField<"bool">;
}

export type BalanceKeyReified<T extends PhantomTypeArgument> = Reified<
  BalanceKey<T>,
  BalanceKeyFields<T>
>;

export class BalanceKey<T extends PhantomTypeArgument> implements StructClass {
  __StructClass = true as const;

  static readonly $typeName = `${PKG_V1}::vault::BalanceKey`;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;

  readonly $typeName = BalanceKey.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::vault::BalanceKey<${PhantomToTypeStr<T>}>`;
  readonly $typeArgs: [PhantomToTypeStr<T>];
  ...
  private constructor(
    typeArgs: [PhantomToTypeStr<T>],
    fields: BalanceKeyFields<T>,
  ) {
    this.$fullTypeName = composeSuiType(
      BalanceKey.$typeName,
      ...typeArgs,
    ) as `${typeof PKG_V1}::vault::BalanceKey<${PhantomToTypeStr<T>}>`;
    this.$typeArgs = typeArgs;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    T: T,
  ): BalanceKeyReified<ToPhantomTypeArgument<T>> {
    return {
      typeName: BalanceKey.$typeName,
      fullTypeName: composeSuiType(
        BalanceKey.$typeName,
        ...[extractType(T)],
      ) as `${typeof PKG_V1}::vault::BalanceKey<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`,
      typeArgs: [extractType(T)] as [
        PhantomToTypeStr<ToPhantomTypeArgument<T>>,
      ],
      ...
      reifiedTypeArgs: [T],
      fromFields: (fields: Record<string, any>) =>
        BalanceKey.fromFields(T, fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        BalanceKey.fromFieldsWithTypes(T, item),
      fromBcs: (data: Uint8Array) => BalanceKey.fromBcs(T, data),
      bcs: BalanceKey.bcs,
      fromJSONField: (field: any) => BalanceKey.fromJSONField(T, field),
      fromJSON: (json: Record<string, any>) => BalanceKey.fromJSON(T, json),
      fromSuiParsedData: (content: SuiParsedData) =>
        BalanceKey.fromSuiParsedData(T, content),
      fromSuiObjectData: (content: SuiObjectData) =>
        BalanceKey.fromSuiObjectData(T, content),
      fetch: async (client: SuiClient, id: string) =>
        BalanceKey.fetch(client, T, id),
      new: (fields: BalanceKeyFields<ToPhantomTypeArgument<T>>) => {
        return new BalanceKey([extractType(T)], fields);
      },
      kind: "StructClassReified",
    };
  }
  ...
  static phantom<T extends PhantomReified<PhantomTypeArgument>>(
    T: T,
  ): PhantomReified<ToTypeStr<BalanceKey<ToPhantomTypeArgument<T>>>> {
    return phantom(BalanceKey.reified(T));
  }
  static get p() {
  ...
  static fromFields<T extends PhantomReified<PhantomTypeArgument>>(
    typeArg: T,
    fields: Record<string, any>,
  ): BalanceKey<ToPhantomTypeArgument<T>> {
    return BalanceKey.reified(typeArg).new({
  ...
  static fromBcs<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return BalanceKey.fromFields(typeArg, BalanceKey.bcs.parse(data));
  }
  ...
  static fromJSON<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    assertReifiedTypeArgsMatch(
      composeSuiType(BalanceKey.$typeName, extractType(typeArg)),
      json.$typeArgs,
      [typeArg],
    );
  ...
  static fromSuiParsedData<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return BalanceKey.fromFieldsWithTypes(typeArg, content);
  }
  ...
  static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (data.bcs) {
      ...
      return BalanceKey.fromBcs(typeArg, fromB64(data.bcs.bcsBytes));
    }
    if (data.content) {
      return BalanceKey.fromSuiParsedData(typeArg, data.content);
    }
    throw new Error(
      "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request.",
    );
  ...
  static async fetch<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    typeArg: T,
    id: string,
  ): Promise<BalanceKey<ToPhantomTypeArgument<T>>> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
