...
export class Aggregator implements StructClass {
  ...
  private constructor(typeArgs: [], fields: AggregatorFields) {
    this.$fullTypeName = composeSuiType(
      Aggregator.$typeName,
      ...typeArgs,
    ) as `${typeof PKG_V1}::aggregator::Aggregator`;
  ...
  static reified(): AggregatorReified {
    return {
      ...
      fromFields: (fields: Record<string, any>) =>
        Aggregator.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        Aggregator.fromFieldsWithTypes(item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        Aggregator.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        Aggregator.fromSuiObjectData(content),
      fetch: async (client: SuiClient, id: string) =>
        Aggregator.fetch(client, id),
  ...
  static fromFields(fields: Record<string, any>): Aggregator {
    return Aggregator.reified().new({
      ...
      minUpdateDelaySeconds: decodeFromFields(
        "u64",
        fields.min_update_delay_seconds,
      ),
      name: decodeFromFields(reified.vector("u8"), fields.name),
      historyLimit: decodeFromFields("u64", fields.history_limit),
      varianceThreshold: decodeFromFields(
        SwitchboardDecimal.reified(),
        fields.variance_threshold,
      ),
      ...
      nextAllowedUpdateTime: decodeFromFields(
        "u64",
        fields.next_allowed_update_time,
      ),
      ...
      limitReadsToWhitelist: decodeFromFields(
        "bool",
        fields.limit_reads_to_whitelist,
      ),
      updateData: decodeFromFields(SlidingWindow.reified(), fields.update_data),
      intervalId: decodeFromFields("u64", fields.interval_id),
      currIntervalPayouts: decodeFromFields(
        "u64",
        fields.curr_interval_payouts,
      ),
      nextIntervalRefreshTime: decodeFromFields(
        "u64",
        fields.next_interval_refresh_time,
      ),
  ...
  static fromFieldsWithTypes(item: FieldsWithTypes): Aggregator {
    ...
    return Aggregator.reified().new({
      ...
      minOracleResults: decodeFromFieldsWithTypes(
        "u64",
        item.fields.min_oracle_results,
      ),
      minUpdateDelaySeconds: decodeFromFieldsWithTypes(
        "u64",
        item.fields.min_update_delay_seconds,
      ),
      ...
      varianceThreshold: decodeFromFieldsWithTypes(
        SwitchboardDecimal.reified(),
        item.fields.variance_threshold,
      ),
      forceReportPeriod: decodeFromFieldsWithTypes(
        "u64",
        item.fields.force_report_period,
      ),
      minJobResults: decodeFromFieldsWithTypes(
        "u64",
        item.fields.min_job_results,
      ),
      crankDisabled: decodeFromFieldsWithTypes(
        "bool",
        item.fields.crank_disabled,
      ),
      crankRowCount: decodeFromFieldsWithTypes(
        "u8",
        item.fields.crank_row_count,
      ),
      nextAllowedUpdateTime: decodeFromFieldsWithTypes(
        "u64",
        item.fields.next_allowed_update_time,
      ),
      ...
      rewardEscrow: decodeFromFieldsWithTypes(
        "address",
        item.fields.reward_escrow,
      ),
      readWhitelist: decodeFromFieldsWithTypes(
        Bag.reified(),
        item.fields.read_whitelist,
      ),
      limitReadsToWhitelist: decodeFromFieldsWithTypes(
        "bool",
        item.fields.limit_reads_to_whitelist,
      ),
      updateData: decodeFromFieldsWithTypes(
        SlidingWindow.reified(),
        item.fields.update_data,
      ),
      intervalId: decodeFromFieldsWithTypes("u64", item.fields.interval_id),
      currIntervalPayouts: decodeFromFieldsWithTypes(
        "u64",
        item.fields.curr_interval_payouts,
      ),
      nextIntervalRefreshTime: decodeFromFieldsWithTypes(
        "u64",
        item.fields.next_interval_refresh_time,
      ),
      escrows: decodeFromFieldsWithTypes(Bag.reified(), item.fields.escrows),
      friendKey: decodeFromFieldsWithTypes(
        reified.vector("u8"),
        item.fields.friend_key,
      ),
  ...
  static fromJSONField(field: any): Aggregator {
    return Aggregator.reified().new({
      ...
      minUpdateDelaySeconds: decodeFromJSONField(
        "u64",
        field.minUpdateDelaySeconds,
      ),
      name: decodeFromJSONField(reified.vector("u8"), field.name),
      historyLimit: decodeFromJSONField("u64", field.historyLimit),
      varianceThreshold: decodeFromJSONField(
        SwitchboardDecimal.reified(),
        field.varianceThreshold,
      ),
      ...
      nextAllowedUpdateTime: decodeFromJSONField(
        "u64",
        field.nextAllowedUpdateTime,
      ),
      ...
      limitReadsToWhitelist: decodeFromJSONField(
        "bool",
        field.limitReadsToWhitelist,
      ),
      updateData: decodeFromJSONField(
        SlidingWindow.reified(),
        field.updateData,
      ),
      intervalId: decodeFromJSONField("u64", field.intervalId),
      currIntervalPayouts: decodeFromJSONField(
        "u64",
        field.currIntervalPayouts,
      ),
      nextIntervalRefreshTime: decodeFromJSONField(
        "u64",
        field.nextIntervalRefreshTime,
      ),
  ...
  static fromSuiParsedData(content: SuiParsedData): Aggregator {
    ...
    if (!isAggregator(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a Aggregator object`,
      );
    }
  ...
  static async fetch(client: SuiClient, id: string): Promise<Aggregator> {
    ...
    if (res.error) {
      throw new Error(
        `error fetching Aggregator object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isAggregator(res.data.bcs.type)
    ) {
...
export type SlidingWindowElementReified = Reified<
  SlidingWindowElement,
...
export class SlidingWindowElement implements StructClass {
  ...
  static reified(): SlidingWindowElementReified {
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        SlidingWindowElement.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        SlidingWindowElement.fromFieldsWithTypes(item),
      ...
      fromJSON: (json: Record<string, any>) =>
        SlidingWindowElement.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
        SlidingWindowElement.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        SlidingWindowElement.fromSuiObjectData(content),
      fetch: async (client: SuiClient, id: string) =>
        SlidingWindowElement.fetch(client, id),
  ...
  static fromBcs(data: Uint8Array): SlidingWindowElement {
    return SlidingWindowElement.fromFields(
      SlidingWindowElement.bcs.parse(data),
    );
  }
  ...
  static fromSuiParsedData(content: SuiParsedData): SlidingWindowElement {
    ...
    if (!isSlidingWindowElement(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a SlidingWindowElement object`,
      );
    }
  ...
  static fromSuiObjectData(data: SuiObjectData): SlidingWindowElement {
    if (data.bcs) {
      if (
        ...
        !isSlidingWindowElement(data.bcs.type)
      ) {
  ...
  static async fetch(
    client: SuiClient,
    id: string,
  ): Promise<SlidingWindowElement> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching SlidingWindowElement object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isSlidingWindowElement(res.data.bcs.type)
    ) {
      throw new Error(
        `object at id ${id} is not a SlidingWindowElement object`,
      );
    }
...
export class SlidingWindow implements StructClass {
  ...
  private constructor(typeArgs: [], fields: SlidingWindowFields) {
    this.$fullTypeName = composeSuiType(
      SlidingWindow.$typeName,
      ...typeArgs,
    ) as `${typeof PKG_V1}::aggregator::SlidingWindow`;
    this.$typeArgs = typeArgs;
  ...
  static reified(): SlidingWindowReified {
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        SlidingWindow.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        SlidingWindow.fromFieldsWithTypes(item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        SlidingWindow.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        SlidingWindow.fromSuiObjectData(content),
      fetch: async (client: SuiClient, id: string) =>
        SlidingWindow.fetch(client, id),
  ...
  static fromFields(fields: Record<string, any>): SlidingWindow {
    return SlidingWindow.reified().new({
      data: decodeFromFields(
        reified.vector(SlidingWindowElement.reified()),
        fields.data,
      ),
      latestResult: decodeFromFields(
        SwitchboardDecimal.reified(),
        fields.latest_result,
      ),
  ...
  static fromFieldsWithTypes(item: FieldsWithTypes): SlidingWindow {
    ...
    return SlidingWindow.reified().new({
      ...
      latestResult: decodeFromFieldsWithTypes(
        SwitchboardDecimal.reified(),
        item.fields.latest_result,
      ),
      latestTimestamp: decodeFromFieldsWithTypes(
        "u64",
        item.fields.latest_timestamp,
      ),
    });
  }
  ...
  toJSONField() {
    return {
      data: fieldToJSON<Vector<SlidingWindowElement>>(
        `vector<${SlidingWindowElement.$typeName}>`,
        this.data,
      ),
  ...
  static fromJSONField(field: any): SlidingWindow {
    return SlidingWindow.reified().new({
      ...
      latestResult: decodeFromJSONField(
        SwitchboardDecimal.reified(),
        field.latestResult,
      ),
  ...
  static fromSuiParsedData(content: SuiParsedData): SlidingWindow {
    ...
    if (!isSlidingWindow(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a SlidingWindow object`,
      );
    }
  ...
  static async fetch(client: SuiClient, id: string): Promise<SlidingWindow> {
    ...
    if (res.error) {
      throw new Error(
        `error fetching SlidingWindow object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isSlidingWindow(res.data.bcs.type)
    ) {
...
export type AggregatorHistoryDataReified = Reified<
  AggregatorHistoryData,
  AggregatorHistoryDataFields
>;
...
export class AggregatorHistoryData implements StructClass {
  ...
  static reified(): AggregatorHistoryDataReified {
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        AggregatorHistoryData.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        AggregatorHistoryData.fromFieldsWithTypes(item),
      ...
      fromJSON: (json: Record<string, any>) =>
        AggregatorHistoryData.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
        AggregatorHistoryData.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        AggregatorHistoryData.fromSuiObjectData(content),
      fetch: async (client: SuiClient, id: string) =>
        AggregatorHistoryData.fetch(client, id),
  ...
  static fromFields(fields: Record<string, any>): AggregatorHistoryData {
    return AggregatorHistoryData.reified().new({
      id: decodeFromFields(UID.reified(), fields.id),
      data: decodeFromFields(
        reified.vector(AggregatorHistoryRow.reified()),
        fields.data,
      ),
  ...
  static fromFieldsWithTypes(item: FieldsWithTypes): AggregatorHistoryData {
    ...
    return AggregatorHistoryData.reified().new({
      ...
      historyWriteIdx: decodeFromFieldsWithTypes(
        "u64",
        item.fields.history_write_idx,
      ),
    });
  }

  static fromBcs(data: Uint8Array): AggregatorHistoryData {
    return AggregatorHistoryData.fromFields(
      AggregatorHistoryData.bcs.parse(data),
    );
  }
  ...
  toJSONField() {
    return {
      id: this.id,
      data: fieldToJSON<Vector<AggregatorHistoryRow>>(
        `vector<${AggregatorHistoryRow.$typeName}>`,
        this.data,
      ),
  ...
  static fromSuiParsedData(content: SuiParsedData): AggregatorHistoryData {
    ...
    if (!isAggregatorHistoryData(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a AggregatorHistoryData object`,
      );
    }
  ...
  static fromSuiObjectData(data: SuiObjectData): AggregatorHistoryData {
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isAggregatorHistoryData(data.bcs.type)
      ) {
  ...
  static async fetch(
    client: SuiClient,
    id: string,
  ): Promise<AggregatorHistoryData> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching AggregatorHistoryData object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isAggregatorHistoryData(res.data.bcs.type)
    ) {
      throw new Error(
        `object at id ${id} is not a AggregatorHistoryData object`,
      );
    }
...
export type AggregatorHistoryRowReified = Reified<
  AggregatorHistoryRow,
...
export class AggregatorHistoryRow implements StructClass {
  ...
  static reified(): AggregatorHistoryRowReified {
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        AggregatorHistoryRow.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        AggregatorHistoryRow.fromFieldsWithTypes(item),
      ...
      fromJSON: (json: Record<string, any>) =>
        AggregatorHistoryRow.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
        AggregatorHistoryRow.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        AggregatorHistoryRow.fromSuiObjectData(content),
      fetch: async (client: SuiClient, id: string) =>
        AggregatorHistoryRow.fetch(client, id),
  ...
  static fromBcs(data: Uint8Array): AggregatorHistoryRow {
    return AggregatorHistoryRow.fromFields(
      AggregatorHistoryRow.bcs.parse(data),
    );
  }
  ...
  static fromSuiParsedData(content: SuiParsedData): AggregatorHistoryRow {
    ...
    if (!isAggregatorHistoryRow(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a AggregatorHistoryRow object`,
      );
    }
  ...
  static fromSuiObjectData(data: SuiObjectData): AggregatorHistoryRow {
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isAggregatorHistoryRow(data.bcs.type)
      ) {
  ...
  static async fetch(
    client: SuiClient,
    id: string,
  ): Promise<AggregatorHistoryRow> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching AggregatorHistoryRow object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isAggregatorHistoryRow(res.data.bcs.type)
    ) {
      throw new Error(
        `object at id ${id} is not a AggregatorHistoryRow object`,
      );
    }
...
export type AggregatorJobDataReified = Reified<
  AggregatorJobData,
  AggregatorJobDataFields
>;
...
export class AggregatorJobData implements StructClass {
  ...
  private constructor(typeArgs: [], fields: AggregatorJobDataFields) {
    this.$fullTypeName = composeSuiType(
      AggregatorJobData.$typeName,
      ...typeArgs,
    ) as `${typeof PKG_V1}::aggregator::AggregatorJobData`;
    this.$typeArgs = typeArgs;
  ...
  static reified(): AggregatorJobDataReified {
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        AggregatorJobData.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
        AggregatorJobData.fromFieldsWithTypes(item),
      ...
      fromSuiParsedData: (content: SuiParsedData) =>
        AggregatorJobData.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        AggregatorJobData.fromSuiObjectData(content),
      fetch: async (client: SuiClient, id: string) =>
        AggregatorJobData.fetch(client, id),
  ...
  static fromFields(fields: Record<string, any>): AggregatorJobData {
    return AggregatorJobData.reified().new({
      ...
      jobsChecksum: decodeFromFields(
        reified.vector("u8"),
        fields.jobs_checksum,
      ),
    });
  }
  ...
  static fromFieldsWithTypes(item: FieldsWithTypes): AggregatorJobData {
    ...
    return AggregatorJobData.reified().new({
      id: decodeFromFieldsWithTypes(UID.reified(), item.fields.id),
      jobKeys: decodeFromFieldsWithTypes(
        reified.vector("address"),
        item.fields.job_keys,
      ),
      jobWeights: decodeFromFieldsWithTypes(
        reified.vector("u8"),
        item.fields.job_weights,
      ),
      jobsChecksum: decodeFromFieldsWithTypes(
        reified.vector("u8"),
        item.fields.jobs_checksum,
      ),
    });
  }
  ...
  static fromJSONField(field: any): AggregatorJobData {
    return AggregatorJobData.reified().new({
      ...
      jobsChecksum: decodeFromJSONField(
        reified.vector("u8"),
        field.jobsChecksum,
      ),
    });
  ...
  static fromSuiParsedData(content: SuiParsedData): AggregatorJobData {
    ...
    if (!isAggregatorJobData(content.type)) {
      throw new Error(
        `object at ${(content.fields as any).id} is not a AggregatorJobData object`,
      );
    }
  ...
  static fromSuiObjectData(data: SuiObjectData): AggregatorJobData {
    if (data.bcs) {
      if (
        data.bcs.dataType !== "moveObject" ||
        !isAggregatorJobData(data.bcs.type)
      ) {
  ...
  static async fetch(
    client: SuiClient,
    id: string,
  ): Promise<AggregatorJobData> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
        `error fetching AggregatorJobData object at id ${id}: ${res.error.code}`,
      );
    }
    if (
      res.data?.bcs?.dataType !== "moveObject" ||
      !isAggregatorJobData(res.data.bcs.type)
    ) {
