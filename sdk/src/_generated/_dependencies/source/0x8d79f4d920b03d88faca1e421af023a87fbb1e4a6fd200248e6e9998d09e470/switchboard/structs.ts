...
export function isAdminCap(type: string): boolean {
  ...
  return type === `${PKG_V1}::switchboard::AdminCap`;
}
...
export class AdminCap implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::switchboard::AdminCap`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = AdminCap.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::switchboard::AdminCap`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: AdminCapFields) {
    this.$fullTypeName = composeSuiType(
      AdminCap.$typeName,
      ...typeArgs,
    ) as `${typeof PKG_V1}::switchboard::AdminCap`;
