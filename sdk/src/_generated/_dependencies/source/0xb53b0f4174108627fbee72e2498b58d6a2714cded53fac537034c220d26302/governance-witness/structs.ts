...
export function isGovernanceWitness(type: string): boolean {
  ...
  return type === `${PKG_V1}::governance_witness::GovernanceWitness`;
}
...
export class GovernanceWitness implements StructClass {
  ...
  static readonly $typeName = `${PKG_V1}::governance_witness::GovernanceWitness`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = GovernanceWitness.$typeName;
  readonly $fullTypeName: `${typeof PKG_V1}::governance_witness::GovernanceWitness`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: GovernanceWitnessFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V1}::governance_witness::GovernanceWitness`;
