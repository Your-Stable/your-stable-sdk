...
export interface ParamUpdatedFields<ComponentType extends PhantomTypeArgument> { paramName: ToField<String>; newValue: ToField<"u64"> }

export type ParamUpdatedReified<ComponentType extends PhantomTypeArgument> = Reified< ParamUpdated<ComponentType>, ParamUpdatedFields<ComponentType> >;

export class ParamUpdated<ComponentType extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 readonly $typeName = ParamUpdated.$typeName; readonly $fullTypeName: `${typeof PKG_V3}::buck_events::ParamUpdated<${PhantomToTypeStr<ComponentType>}>`; readonly $typeArgs: [PhantomToTypeStr<ComponentType>]; readonly $isPhantom = ParamUpdated.$isPhantom;

 readonly paramName: ToField<String>; readonly newValue: ToField<"u64">

 private constructor(typeArgs: [PhantomToTypeStr<ComponentType>], fields: ParamUpdatedFields<ComponentType>, ) { this.$fullTypeName = composeSuiType( ParamUpdated.$typeName, ...typeArgs ) as `${typeof PKG_V3}::buck_events::ParamUpdated<${PhantomToTypeStr<ComponentType>}>`; this.$typeArgs = typeArgs;

 this.paramName = fields.paramName;; this.newValue = fields.newValue; }

 static reified<ComponentType extends PhantomReified<PhantomTypeArgument>>( ComponentType: ComponentType ): ParamUpdatedReified<ToPhantomTypeArgument<ComponentType>> { return { typeName: ParamUpdated.$typeName, fullTypeName: composeSuiType( ParamUpdated.$typeName, ...[extractType(ComponentType)] ) as `${typeof PKG_V3}::buck_events::ParamUpdated<${PhantomToTypeStr<ToPhantomTypeArgument<ComponentType>>}>`, typeArgs: [ extractType(ComponentType) ] as [PhantomToTypeStr<ToPhantomTypeArgument<ComponentType>>], isPhantom: ParamUpdated.$isPhantom, reifiedTypeArgs: [ComponentType], fromFields: (fields: Record<string, any>) => ParamUpdated.fromFields( ComponentType, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => ParamUpdated.fromFieldsWithTypes( ComponentType, item, ), fromBcs: (data: Uint8Array) => ParamUpdated.fromBcs( ComponentType, data, ), bcs: ParamUpdated.bcs, fromJSONField: (field: any) => ParamUpdated.fromJSONField( ComponentType, field, ), fromJSON: (json: Record<string, any>) => ParamUpdated.fromJSON( ComponentType, json, ), fromSuiParsedData: (content: SuiParsedData) => ParamUpdated.fromSuiParsedData( ComponentType, content, ), fromSuiObjectData: (content: SuiObjectData) => ParamUpdated.fromSuiObjectData( ComponentType, content, ), fetch: async (client: SuiClient, id: string) => ParamUpdated.fetch( client, ComponentType, id, ), new: ( fields: ParamUpdatedFields<ToPhantomTypeArgument<ComponentType>>, ) => { return new ParamUpdated( [extractType(ComponentType)], fields ) }, kind: "StructClassReified", } }

 static get r() { return ParamUpdated.reified }

 static phantom<ComponentType extends PhantomReified<PhantomTypeArgument>>( ComponentType: ComponentType ): PhantomReified<ToTypeStr<ParamUpdated<ToPhantomTypeArgument<ComponentType>>>> { return phantom(ParamUpdated.reified( ComponentType )); } static get p() { return ParamUpdated.phantom }
 ...
 static fromFields<ComponentType extends PhantomReified<PhantomTypeArgument>>( typeArg: ComponentType, fields: Record<string, any> ): ParamUpdated<ToPhantomTypeArgument<ComponentType>> { return ParamUpdated.reified( typeArg, ).new( { paramName: decodeFromFields(String.reified(), fields.param_name), newValue: decodeFromFields("u64", fields.new_value) } ) }

 static fromFieldsWithTypes<ComponentType extends PhantomReified<PhantomTypeArgument>>( typeArg: ComponentType, item: FieldsWithTypes ): ParamUpdated<ToPhantomTypeArgument<ComponentType>> { if (!isParamUpdated(item.type)) { throw new Error("not a ParamUpdated type");
 ...
 static fromBcs<ComponentType extends PhantomReified<PhantomTypeArgument>>( typeArg: ComponentType, data: Uint8Array ): ParamUpdated<ToPhantomTypeArgument<ComponentType>> { return ParamUpdated.fromFields( typeArg, ParamUpdated.bcs.parse(data) ) }
 ...
 static fromJSONField<ComponentType extends PhantomReified<PhantomTypeArgument>>( typeArg: ComponentType, field: any ): ParamUpdated<ToPhantomTypeArgument<ComponentType>> { return ParamUpdated.reified( typeArg, ).new( { paramName: decodeFromJSONField(String.reified(), field.paramName), newValue: decodeFromJSONField("u64", field.newValue) } ) }

 static fromJSON<ComponentType extends PhantomReified<PhantomTypeArgument>>( typeArg: ComponentType, json: Record<string, any> ): ParamUpdated<ToPhantomTypeArgument<ComponentType>> { if (json.$typeName !== ParamUpdated.$typeName) { throw new Error("not a WithTwoGenerics json object") }; assertReifiedTypeArgsMatch( composeSuiType(ParamUpdated.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg], )

 return ParamUpdated.fromJSONField( typeArg, json, ) }

 static fromSuiParsedData<ComponentType extends PhantomReified<PhantomTypeArgument>>( typeArg: ComponentType, content: SuiParsedData ): ParamUpdated<ToPhantomTypeArgument<ComponentType>> { if (content.dataType !== "moveObject") { throw new Error("not an object"); } if (!isParamUpdated(content.type)) { throw new Error(`object at ${(content.fields as any).id} is not a ParamUpdated object`); } return ParamUpdated.fromFieldsWithTypes( typeArg, content ); }

 static fromSuiObjectData<ComponentType extends PhantomReified<PhantomTypeArgument>>( typeArg: ComponentType, data: SuiObjectData ): ParamUpdated<ToPhantomTypeArgument<ComponentType>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isParamUpdated(data.bcs.type)) { throw new Error(`object at is not a ParamUpdated object`); }
 ...
 static async fetch<ComponentType extends PhantomReified<PhantomTypeArgument>>( client: SuiClient, typeArg: ComponentType, id: string ): Promise<ParamUpdated<ToPhantomTypeArgument<ComponentType>>> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching ParamUpdated object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isParamUpdated(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a ParamUpdated object`); }
...
export interface LiquidationFields<T extends PhantomTypeArgument> { priceN: ToField<"u64">; priceM: ToField<"u64">; collAmount: ToField<"u64">; debtAmount: ToField<"u64">; tcr: ToField<Option<"u64">>; debtor: ToField<"address"> }

export type LiquidationReified<T extends PhantomTypeArgument> = Reified< Liquidation<T>, LiquidationFields<T> >;

export class Liquidation<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 readonly $typeName = Liquidation.$typeName; readonly $fullTypeName: `${typeof PKG_V14}::buck_events::Liquidation<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = Liquidation.$isPhantom;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: LiquidationFields<T>, ) { this.$fullTypeName = composeSuiType( Liquidation.$typeName, ...typeArgs ) as `${typeof PKG_V14}::buck_events::Liquidation<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;
 ...
 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): LiquidationReified<ToPhantomTypeArgument<T>> { return { typeName: Liquidation.$typeName, fullTypeName: composeSuiType( Liquidation.$typeName, ...[extractType(T)] ) as `${typeof PKG_V14}::buck_events::Liquidation<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: Liquidation.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => Liquidation.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Liquidation.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => Liquidation.fromBcs( T, data, ), bcs: Liquidation.bcs, fromJSONField: (field: any) => Liquidation.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => Liquidation.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => Liquidation.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => Liquidation.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => Liquidation.fetch( client, T, id, ), new: ( fields: LiquidationFields<ToPhantomTypeArgument<T>>, ) => { return new Liquidation( [extractType(T)], fields ) }, kind: "StructClassReified", } }

 static get r() { return Liquidation.reified }

 static phantom<T extends PhantomReified<PhantomTypeArgument>>( T: T ): PhantomReified<ToTypeStr<Liquidation<ToPhantomTypeArgument<T>>>> { return phantom(Liquidation.reified( T )); } static get p() { return Liquidation.phantom }
 ...
 static fromFields<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, fields: Record<string, any> ): Liquidation<ToPhantomTypeArgument<T>> { return Liquidation.reified( typeArg, ).new( { priceN: decodeFromFields("u64", fields.price_n), priceM: decodeFromFields("u64", fields.price_m), collAmount: decodeFromFields("u64", fields.coll_amount), debtAmount: decodeFromFields("u64", fields.debt_amount), tcr: decodeFromFields(Option.reified("u64"), fields.tcr), debtor: decodeFromFields("address", fields.debtor) } ) }

 static fromFieldsWithTypes<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, item: FieldsWithTypes ): Liquidation<ToPhantomTypeArgument<T>> { if (!isLiquidation(item.type)) { throw new Error("not a Liquidation type");
 ...
 static fromBcs<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: Uint8Array ): Liquidation<ToPhantomTypeArgument<T>> { return Liquidation.fromFields( typeArg, Liquidation.bcs.parse(data) ) }
 ...
 static fromJSONField<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, field: any ): Liquidation<ToPhantomTypeArgument<T>> { return Liquidation.reified( typeArg, ).new( { priceN: decodeFromJSONField("u64", field.priceN), priceM: decodeFromJSONField("u64", field.priceM), collAmount: decodeFromJSONField("u64", field.collAmount), debtAmount: decodeFromJSONField("u64", field.debtAmount), tcr: decodeFromJSONField(Option.reified("u64"), field.tcr), debtor: decodeFromJSONField("address", field.debtor) } ) }

 static fromJSON<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, json: Record<string, any> ): Liquidation<ToPhantomTypeArgument<T>> { if (json.$typeName !== Liquidation.$typeName) { throw new Error("not a WithTwoGenerics json object") }; assertReifiedTypeArgsMatch( composeSuiType(Liquidation.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg], )

 return Liquidation.fromJSONField( typeArg, json, ) }

 static fromSuiParsedData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, content: SuiParsedData ): Liquidation<ToPhantomTypeArgument<T>> { if (content.dataType !== "moveObject") { throw new Error("not an object"); } if (!isLiquidation(content.type)) { throw new Error(`object at ${(content.fields as any).id} is not a Liquidation object`); } return Liquidation.fromFieldsWithTypes( typeArg, content ); }

 static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: SuiObjectData ): Liquidation<ToPhantomTypeArgument<T>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isLiquidation(data.bcs.type)) { throw new Error(`object at is not a Liquidation object`); }
