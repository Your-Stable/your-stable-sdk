...
export interface TankFields<BUCK extends PhantomTypeArgument, T extends PhantomTypeArgument> { id: ToField<UID>; reserve: ToField<Balance<BUCK>>; collateralPool: ToField<Balance<T>>; currentP: ToField<"u64">; currentEpoch: ToField<"u64">; epochScaleSumMap: ToField<Table<ToPhantom<EpochAndScale>, "u64">>; currentScale: ToField<"u64">; bktPool: ToField<Balance<ToPhantom<BKT>>>; epochScaleGainMap: ToField<Table<ToPhantom<EpochAndScale>, "u64">>; totalFlashLoanAmount: ToField<"u64"> }

export type TankReified<BUCK extends PhantomTypeArgument, T extends PhantomTypeArgument> = Reified< Tank<BUCK, T>, TankFields<BUCK, T> >;

export class Tank<BUCK extends PhantomTypeArgument, T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::tank::Tank`; static readonly $numTypeParams = 2; static readonly $isPhantom = [true,true,] as const;

 readonly $typeName = Tank.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::tank::Tank<${PhantomToTypeStr<BUCK>}, ${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<BUCK>, PhantomToTypeStr<T>]; readonly $isPhantom = Tank.$isPhantom;

 readonly id: ToField<UID>; readonly reserve: ToField<Balance<BUCK>>; readonly collateralPool: ToField<Balance<T>>; readonly currentP: ToField<"u64">; readonly currentEpoch: ToField<"u64">; readonly epochScaleSumMap: ToField<Table<ToPhantom<EpochAndScale>, "u64">>; readonly currentScale: ToField<"u64">; readonly bktPool: ToField<Balance<ToPhantom<BKT>>>; readonly epochScaleGainMap: ToField<Table<ToPhantom<EpochAndScale>, "u64">>; readonly totalFlashLoanAmount: ToField<"u64">

 private constructor(typeArgs: [PhantomToTypeStr<BUCK>, PhantomToTypeStr<T>], fields: TankFields<BUCK, T>, ) { this.$fullTypeName = composeSuiType( Tank.$typeName, ...typeArgs ) as `${typeof PKG_V1}::tank::Tank<${PhantomToTypeStr<BUCK>}, ${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;
 ...
 static reified<BUCK extends PhantomReified<PhantomTypeArgument>, T extends PhantomReified<PhantomTypeArgument>>( BUCK: BUCK, T: T ): TankReified<ToPhantomTypeArgument<BUCK>, ToPhantomTypeArgument<T>> { return { typeName: Tank.$typeName, fullTypeName: composeSuiType( Tank.$typeName, ...[extractType(BUCK), extractType(T)] ) as `${typeof PKG_V1}::tank::Tank<${PhantomToTypeStr<ToPhantomTypeArgument<BUCK>>}, ${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(BUCK), extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<BUCK>>, PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: Tank.$isPhantom, reifiedTypeArgs: [BUCK, T], fromFields: (fields: Record<string, any>) => Tank.fromFields( [BUCK, T], fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Tank.fromFieldsWithTypes( [BUCK, T], item, ), fromBcs: (data: Uint8Array) => Tank.fromBcs( [BUCK, T], data, ), bcs: Tank.bcs, fromJSONField: (field: any) => Tank.fromJSONField( [BUCK, T], field, ), fromJSON: (json: Record<string, any>) => Tank.fromJSON( [BUCK, T], json, ), fromSuiParsedData: (content: SuiParsedData) => Tank.fromSuiParsedData( [BUCK, T], content, ), fromSuiObjectData: (content: SuiObjectData) => Tank.fromSuiObjectData( [BUCK, T], content, ), fetch: async (client: SuiClient, id: string) => Tank.fetch( client, [BUCK, T], id, ), new: ( fields: TankFields<ToPhantomTypeArgument<BUCK>, ToPhantomTypeArgument<T>>, ) => { return new Tank( [extractType(BUCK), extractType(T)], fields ) }, kind: "StructClassReified", } }

 static get r() { return Tank.reified }

 static phantom<BUCK extends PhantomReified<PhantomTypeArgument>, T extends PhantomReified<PhantomTypeArgument>>( BUCK: BUCK, T: T ): PhantomReified<ToTypeStr<Tank<ToPhantomTypeArgument<BUCK>, ToPhantomTypeArgument<T>>>> { return phantom(Tank.reified( BUCK, T )); } static get p() { return Tank.phantom }
 ...
 static fromBcs<BUCK extends PhantomReified<PhantomTypeArgument>, T extends PhantomReified<PhantomTypeArgument>>( typeArgs: [BUCK, T], data: Uint8Array ): Tank<ToPhantomTypeArgument<BUCK>, ToPhantomTypeArgument<T>> { return Tank.fromFields( typeArgs, Tank.bcs.parse(data) ) }
 ...
 static fromJSONField<BUCK extends PhantomReified<PhantomTypeArgument>, T extends PhantomReified<PhantomTypeArgument>>( typeArgs: [BUCK, T], field: any ): Tank<ToPhantomTypeArgument<BUCK>, ToPhantomTypeArgument<T>> { return Tank.reified( typeArgs[0], typeArgs[1], ).new( { id: decodeFromJSONField(UID.reified(), field.id), reserve: decodeFromJSONField(Balance.reified(typeArgs[0]), field.reserve), collateralPool: decodeFromJSONField(Balance.reified(typeArgs[1]), field.collateralPool), currentP: decodeFromJSONField("u64", field.currentP), currentEpoch: decodeFromJSONField("u64", field.currentEpoch), epochScaleSumMap: decodeFromJSONField(Table.reified(reified.phantom(EpochAndScale.reified()), reified.phantom("u64")), field.epochScaleSumMap), currentScale: decodeFromJSONField("u64", field.currentScale), bktPool: decodeFromJSONField(Balance.reified(reified.phantom(BKT.reified())), field.bktPool), epochScaleGainMap: decodeFromJSONField(Table.reified(reified.phantom(EpochAndScale.reified()), reified.phantom("u64")), field.epochScaleGainMap), totalFlashLoanAmount: decodeFromJSONField("u64", field.totalFlashLoanAmount) } ) }

 static fromJSON<BUCK extends PhantomReified<PhantomTypeArgument>, T extends PhantomReified<PhantomTypeArgument>>( typeArgs: [BUCK, T], json: Record<string, any> ): Tank<ToPhantomTypeArgument<BUCK>, ToPhantomTypeArgument<T>> { if (json.$typeName !== Tank.$typeName) { throw new Error("not a WithTwoGenerics json object") }; assertReifiedTypeArgsMatch( composeSuiType(Tank.$typeName, ...typeArgs.map(extractType)), json.$typeArgs, typeArgs, )

 return Tank.fromJSONField( typeArgs, json, ) }

 static fromSuiParsedData<BUCK extends PhantomReified<PhantomTypeArgument>, T extends PhantomReified<PhantomTypeArgument>>( typeArgs: [BUCK, T], content: SuiParsedData ): Tank<ToPhantomTypeArgument<BUCK>, ToPhantomTypeArgument<T>> { if (content.dataType !== "moveObject") { throw new Error("not an object"); } if (!isTank(content.type)) { throw new Error(`object at ${(content.fields as any).id} is not a Tank object`); } return Tank.fromFieldsWithTypes( typeArgs, content ); }

 static fromSuiObjectData<BUCK extends PhantomReified<PhantomTypeArgument>, T extends PhantomReified<PhantomTypeArgument>>( typeArgs: [BUCK, T], data: SuiObjectData ): Tank<ToPhantomTypeArgument<BUCK>, ToPhantomTypeArgument<T>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isTank(data.bcs.type)) { throw new Error(`object at is not a Tank object`); }
 ...
 static async fetch<BUCK extends PhantomReified<PhantomTypeArgument>, T extends PhantomReified<PhantomTypeArgument>>( client: SuiClient, typeArgs: [BUCK, T], id: string ): Promise<Tank<ToPhantomTypeArgument<BUCK>, ToPhantomTypeArgument<T>>> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching Tank object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isTank(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a Tank object`); }
...
export interface ContributorTokenFields<BUCK extends PhantomTypeArgument, T extends PhantomTypeArgument> { id: ToField<UID>; depositAmount: ToField<"u64">; startP: ToField<"u64">; startS: ToField<"u64">; startG: ToField<"u64">; startEpoch: ToField<"u64">; startScale: ToField<"u64">; ctxEpoch: ToField<"u64"> }

export type ContributorTokenReified<BUCK extends PhantomTypeArgument, T extends PhantomTypeArgument> = Reified< ContributorToken<BUCK, T>, ContributorTokenFields<BUCK, T> >;

export class ContributorToken<BUCK extends PhantomTypeArgument, T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 readonly $typeName = ContributorToken.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::tank::ContributorToken<${PhantomToTypeStr<BUCK>}, ${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<BUCK>, PhantomToTypeStr<T>]; readonly $isPhantom = ContributorToken.$isPhantom;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<BUCK>, PhantomToTypeStr<T>], fields: ContributorTokenFields<BUCK, T>, ) { this.$fullTypeName = composeSuiType( ContributorToken.$typeName, ...typeArgs ) as `${typeof PKG_V1}::tank::ContributorToken<${PhantomToTypeStr<BUCK>}, ${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;
 ...
 static reified<BUCK extends PhantomReified<PhantomTypeArgument>, T extends PhantomReified<PhantomTypeArgument>>( BUCK: BUCK, T: T ): ContributorTokenReified<ToPhantomTypeArgument<BUCK>, ToPhantomTypeArgument<T>> { return { typeName: ContributorToken.$typeName, fullTypeName: composeSuiType( ContributorToken.$typeName, ...[extractType(BUCK), extractType(T)] ) as `${typeof PKG_V1}::tank::ContributorToken<${PhantomToTypeStr<ToPhantomTypeArgument<BUCK>>}, ${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(BUCK), extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<BUCK>>, PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: ContributorToken.$isPhantom, reifiedTypeArgs: [BUCK, T], fromFields: (fields: Record<string, any>) => ContributorToken.fromFields( [BUCK, T], fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => ContributorToken.fromFieldsWithTypes( [BUCK, T], item, ), fromBcs: (data: Uint8Array) => ContributorToken.fromBcs( [BUCK, T], data, ), bcs: ContributorToken.bcs, fromJSONField: (field: any) => ContributorToken.fromJSONField( [BUCK, T], field, ), fromJSON: (json: Record<string, any>) => ContributorToken.fromJSON( [BUCK, T], json, ), fromSuiParsedData: (content: SuiParsedData) => ContributorToken.fromSuiParsedData( [BUCK, T], content, ), fromSuiObjectData: (content: SuiObjectData) => ContributorToken.fromSuiObjectData( [BUCK, T], content, ), fetch: async (client: SuiClient, id: string) => ContributorToken.fetch( client, [BUCK, T], id, ), new: ( fields: ContributorTokenFields<ToPhantomTypeArgument<BUCK>, ToPhantomTypeArgument<T>>, ) => { return new ContributorToken( [extractType(BUCK), extractType(T)], fields ) }, kind: "StructClassReified", } }

 static get r() { return ContributorToken.reified }

 static phantom<BUCK extends PhantomReified<PhantomTypeArgument>, T extends PhantomReified<PhantomTypeArgument>>( BUCK: BUCK, T: T ): PhantomReified<ToTypeStr<ContributorToken<ToPhantomTypeArgument<BUCK>, ToPhantomTypeArgument<T>>>> { return phantom(ContributorToken.reified( BUCK, T )); } static get p() { return ContributorToken.phantom }
 ...
 static fromFields<BUCK extends PhantomReified<PhantomTypeArgument>, T extends PhantomReified<PhantomTypeArgument>>( typeArgs: [BUCK, T], fields: Record<string, any> ): ContributorToken<ToPhantomTypeArgument<BUCK>, ToPhantomTypeArgument<T>> { return ContributorToken.reified( typeArgs[0], typeArgs[1], ).new( { id: decodeFromFields(UID.reified(), fields.id), depositAmount: decodeFromFields("u64", fields.deposit_amount), startP: decodeFromFields("u64", fields.start_p), startS: decodeFromFields("u64", fields.start_s), startG: decodeFromFields("u64", fields.start_g), startEpoch: decodeFromFields("u64", fields.start_epoch), startScale: decodeFromFields("u64", fields.start_scale), ctxEpoch: decodeFromFields("u64", fields.ctx_epoch) } ) }

 static fromFieldsWithTypes<BUCK extends PhantomReified<PhantomTypeArgument>, T extends PhantomReified<PhantomTypeArgument>>( typeArgs: [BUCK, T], item: FieldsWithTypes ): ContributorToken<ToPhantomTypeArgument<BUCK>, ToPhantomTypeArgument<T>> { if (!isContributorToken(item.type)) { throw new Error("not a ContributorToken type");
 ...
 static fromBcs<BUCK extends PhantomReified<PhantomTypeArgument>, T extends PhantomReified<PhantomTypeArgument>>( typeArgs: [BUCK, T], data: Uint8Array ): ContributorToken<ToPhantomTypeArgument<BUCK>, ToPhantomTypeArgument<T>> { return ContributorToken.fromFields( typeArgs, ContributorToken.bcs.parse(data) ) }
 ...
 static fromJSONField<BUCK extends PhantomReified<PhantomTypeArgument>, T extends PhantomReified<PhantomTypeArgument>>( typeArgs: [BUCK, T], field: any ): ContributorToken<ToPhantomTypeArgument<BUCK>, ToPhantomTypeArgument<T>> { return ContributorToken.reified( typeArgs[0], typeArgs[1], ).new( { id: decodeFromJSONField(UID.reified(), field.id), depositAmount: decodeFromJSONField("u64", field.depositAmount), startP: decodeFromJSONField("u64", field.startP), startS: decodeFromJSONField("u64", field.startS), startG: decodeFromJSONField("u64", field.startG), startEpoch: decodeFromJSONField("u64", field.startEpoch), startScale: decodeFromJSONField("u64", field.startScale), ctxEpoch: decodeFromJSONField("u64", field.ctxEpoch) } ) }

 static fromJSON<BUCK extends PhantomReified<PhantomTypeArgument>, T extends PhantomReified<PhantomTypeArgument>>( typeArgs: [BUCK, T], json: Record<string, any> ): ContributorToken<ToPhantomTypeArgument<BUCK>, ToPhantomTypeArgument<T>> { if (json.$typeName !== ContributorToken.$typeName) { throw new Error("not a WithTwoGenerics json object") }; assertReifiedTypeArgsMatch( composeSuiType(ContributorToken.$typeName, ...typeArgs.map(extractType)), json.$typeArgs, typeArgs, )

 return ContributorToken.fromJSONField( typeArgs, json, ) }

 static fromSuiParsedData<BUCK extends PhantomReified<PhantomTypeArgument>, T extends PhantomReified<PhantomTypeArgument>>( typeArgs: [BUCK, T], content: SuiParsedData ): ContributorToken<ToPhantomTypeArgument<BUCK>, ToPhantomTypeArgument<T>> { if (content.dataType !== "moveObject") { throw new Error("not an object"); } if (!isContributorToken(content.type)) { throw new Error(`object at ${(content.fields as any).id} is not a ContributorToken object`); } return ContributorToken.fromFieldsWithTypes( typeArgs, content ); }

 static fromSuiObjectData<BUCK extends PhantomReified<PhantomTypeArgument>, T extends PhantomReified<PhantomTypeArgument>>( typeArgs: [BUCK, T], data: SuiObjectData ): ContributorToken<ToPhantomTypeArgument<BUCK>, ToPhantomTypeArgument<T>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isContributorToken(data.bcs.type)) { throw new Error(`object at is not a ContributorToken object`); }
 ...
 static async fetch<BUCK extends PhantomReified<PhantomTypeArgument>, T extends PhantomReified<PhantomTypeArgument>>( client: SuiClient, typeArgs: [BUCK, T], id: string ): Promise<ContributorToken<ToPhantomTypeArgument<BUCK>, ToPhantomTypeArgument<T>>> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching ContributorToken object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isContributorToken(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a ContributorToken object`); }
...
export interface FlashReceiptFields<BUCK extends PhantomTypeArgument, T extends PhantomTypeArgument> { amount: ToField<"u64">; fee: ToField<"u64"> }

export type FlashReceiptReified<BUCK extends PhantomTypeArgument, T extends PhantomTypeArgument> = Reified< FlashReceipt<BUCK, T>, FlashReceiptFields<BUCK, T> >;

export class FlashReceipt<BUCK extends PhantomTypeArgument, T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 readonly $typeName = FlashReceipt.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::tank::FlashReceipt<${PhantomToTypeStr<BUCK>}, ${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<BUCK>, PhantomToTypeStr<T>]; readonly $isPhantom = FlashReceipt.$isPhantom;

 readonly amount: ToField<"u64">; readonly fee: ToField<"u64">

 private constructor(typeArgs: [PhantomToTypeStr<BUCK>, PhantomToTypeStr<T>], fields: FlashReceiptFields<BUCK, T>, ) { this.$fullTypeName = composeSuiType( FlashReceipt.$typeName, ...typeArgs ) as `${typeof PKG_V1}::tank::FlashReceipt<${PhantomToTypeStr<BUCK>}, ${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;

 this.amount = fields.amount;; this.fee = fields.fee; }

 static reified<BUCK extends PhantomReified<PhantomTypeArgument>, T extends PhantomReified<PhantomTypeArgument>>( BUCK: BUCK, T: T ): FlashReceiptReified<ToPhantomTypeArgument<BUCK>, ToPhantomTypeArgument<T>> { return { typeName: FlashReceipt.$typeName, fullTypeName: composeSuiType( FlashReceipt.$typeName, ...[extractType(BUCK), extractType(T)] ) as `${typeof PKG_V1}::tank::FlashReceipt<${PhantomToTypeStr<ToPhantomTypeArgument<BUCK>>}, ${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(BUCK), extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<BUCK>>, PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: FlashReceipt.$isPhantom, reifiedTypeArgs: [BUCK, T], fromFields: (fields: Record<string, any>) => FlashReceipt.fromFields( [BUCK, T], fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => FlashReceipt.fromFieldsWithTypes( [BUCK, T], item, ), fromBcs: (data: Uint8Array) => FlashReceipt.fromBcs( [BUCK, T], data, ), bcs: FlashReceipt.bcs, fromJSONField: (field: any) => FlashReceipt.fromJSONField( [BUCK, T], field, ), fromJSON: (json: Record<string, any>) => FlashReceipt.fromJSON( [BUCK, T], json, ), fromSuiParsedData: (content: SuiParsedData) => FlashReceipt.fromSuiParsedData( [BUCK, T], content, ), fromSuiObjectData: (content: SuiObjectData) => FlashReceipt.fromSuiObjectData( [BUCK, T], content, ), fetch: async (client: SuiClient, id: string) => FlashReceipt.fetch( client, [BUCK, T], id, ), new: ( fields: FlashReceiptFields<ToPhantomTypeArgument<BUCK>, ToPhantomTypeArgument<T>>, ) => { return new FlashReceipt( [extractType(BUCK), extractType(T)], fields ) }, kind: "StructClassReified", } }

 static get r() { return FlashReceipt.reified }

 static phantom<BUCK extends PhantomReified<PhantomTypeArgument>, T extends PhantomReified<PhantomTypeArgument>>( BUCK: BUCK, T: T ): PhantomReified<ToTypeStr<FlashReceipt<ToPhantomTypeArgument<BUCK>, ToPhantomTypeArgument<T>>>> { return phantom(FlashReceipt.reified( BUCK, T )); } static get p() { return FlashReceipt.phantom }
 ...
 static fromFields<BUCK extends PhantomReified<PhantomTypeArgument>, T extends PhantomReified<PhantomTypeArgument>>( typeArgs: [BUCK, T], fields: Record<string, any> ): FlashReceipt<ToPhantomTypeArgument<BUCK>, ToPhantomTypeArgument<T>> { return FlashReceipt.reified( typeArgs[0], typeArgs[1], ).new( { amount: decodeFromFields("u64", fields.amount), fee: decodeFromFields("u64", fields.fee) } ) }

 static fromFieldsWithTypes<BUCK extends PhantomReified<PhantomTypeArgument>, T extends PhantomReified<PhantomTypeArgument>>( typeArgs: [BUCK, T], item: FieldsWithTypes ): FlashReceipt<ToPhantomTypeArgument<BUCK>, ToPhantomTypeArgument<T>> { if (!isFlashReceipt(item.type)) { throw new Error("not a FlashReceipt type");
 ...
 static fromBcs<BUCK extends PhantomReified<PhantomTypeArgument>, T extends PhantomReified<PhantomTypeArgument>>( typeArgs: [BUCK, T], data: Uint8Array ): FlashReceipt<ToPhantomTypeArgument<BUCK>, ToPhantomTypeArgument<T>> { return FlashReceipt.fromFields( typeArgs, FlashReceipt.bcs.parse(data) ) }
 ...
 static fromJSONField<BUCK extends PhantomReified<PhantomTypeArgument>, T extends PhantomReified<PhantomTypeArgument>>( typeArgs: [BUCK, T], field: any ): FlashReceipt<ToPhantomTypeArgument<BUCK>, ToPhantomTypeArgument<T>> { return FlashReceipt.reified( typeArgs[0], typeArgs[1], ).new( { amount: decodeFromJSONField("u64", field.amount), fee: decodeFromJSONField("u64", field.fee) } ) }

 static fromJSON<BUCK extends PhantomReified<PhantomTypeArgument>, T extends PhantomReified<PhantomTypeArgument>>( typeArgs: [BUCK, T], json: Record<string, any> ): FlashReceipt<ToPhantomTypeArgument<BUCK>, ToPhantomTypeArgument<T>> { if (json.$typeName !== FlashReceipt.$typeName) { throw new Error("not a WithTwoGenerics json object") }; assertReifiedTypeArgsMatch( composeSuiType(FlashReceipt.$typeName, ...typeArgs.map(extractType)), json.$typeArgs, typeArgs, )

 return FlashReceipt.fromJSONField( typeArgs, json, ) }

 static fromSuiParsedData<BUCK extends PhantomReified<PhantomTypeArgument>, T extends PhantomReified<PhantomTypeArgument>>( typeArgs: [BUCK, T], content: SuiParsedData ): FlashReceipt<ToPhantomTypeArgument<BUCK>, ToPhantomTypeArgument<T>> { if (content.dataType !== "moveObject") { throw new Error("not an object"); } if (!isFlashReceipt(content.type)) { throw new Error(`object at ${(content.fields as any).id} is not a FlashReceipt object`); } return FlashReceipt.fromFieldsWithTypes( typeArgs, content ); }

 static fromSuiObjectData<BUCK extends PhantomReified<PhantomTypeArgument>, T extends PhantomReified<PhantomTypeArgument>>( typeArgs: [BUCK, T], data: SuiObjectData ): FlashReceipt<ToPhantomTypeArgument<BUCK>, ToPhantomTypeArgument<T>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isFlashReceipt(data.bcs.type)) { throw new Error(`object at is not a FlashReceipt object`); }
 ...
 static async fetch<BUCK extends PhantomReified<PhantomTypeArgument>, T extends PhantomReified<PhantomTypeArgument>>( client: SuiClient, typeArgs: [BUCK, T], id: string ): Promise<FlashReceipt<ToPhantomTypeArgument<BUCK>, ToPhantomTypeArgument<T>>> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching FlashReceipt object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isFlashReceipt(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a FlashReceipt object`); }
