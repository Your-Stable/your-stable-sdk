...
export interface WellFields<T extends PhantomTypeArgument> { id: ToField<UID>; sharedPool: ToField<Balance<T>>; reserve: ToField<Balance<T>>; staked: ToField<Balance<ToPhantom<BKT>>>; totalWeight: ToField<"u64">; currentS: ToField<"u128"> }

export type WellReified<T extends PhantomTypeArgument> = Reified< Well<T>, WellFields<T> >;

export class Well<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::well::Well`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = Well.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::well::Well<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = Well.$isPhantom;

 readonly id: ToField<UID>; readonly sharedPool: ToField<Balance<T>>; readonly reserve: ToField<Balance<T>>; readonly staked: ToField<Balance<ToPhantom<BKT>>>; readonly totalWeight: ToField<"u64">; readonly currentS: ToField<"u128">

 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: WellFields<T>, ) { this.$fullTypeName = composeSuiType( Well.$typeName, ...typeArgs ) as `${typeof PKG_V1}::well::Well<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;
 ...
 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): WellReified<ToPhantomTypeArgument<T>> { return { typeName: Well.$typeName, fullTypeName: composeSuiType( Well.$typeName, ...[extractType(T)] ) as `${typeof PKG_V1}::well::Well<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: Well.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => Well.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Well.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => Well.fromBcs( T, data, ), bcs: Well.bcs, fromJSONField: (field: any) => Well.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => Well.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => Well.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => Well.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => Well.fetch( client, T, id, ), new: ( fields: WellFields<ToPhantomTypeArgument<T>>, ) => { return new Well( [extractType(T)], fields ) }, kind: "StructClassReified", } }

 static get r() { return Well.reified }

 static phantom<T extends PhantomReified<PhantomTypeArgument>>( T: T ): PhantomReified<ToTypeStr<Well<ToPhantomTypeArgument<T>>>> { return phantom(Well.reified( T )); } static get p() { return Well.phantom }
 ...
 static fromFields<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, fields: Record<string, any> ): Well<ToPhantomTypeArgument<T>> { return Well.reified( typeArg, ).new( { id: decodeFromFields(UID.reified(), fields.id), sharedPool: decodeFromFields(Balance.reified(typeArg), fields.shared_pool), reserve: decodeFromFields(Balance.reified(typeArg), fields.reserve), staked: decodeFromFields(Balance.reified(reified.phantom(BKT.reified())), fields.staked), totalWeight: decodeFromFields("u64", fields.total_weight), currentS: decodeFromFields("u128", fields.current_s) } ) }

 static fromFieldsWithTypes<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, item: FieldsWithTypes ): Well<ToPhantomTypeArgument<T>> { if (!isWell(item.type)) { throw new Error("not a Well type");
 ...
 static fromBcs<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: Uint8Array ): Well<ToPhantomTypeArgument<T>> { return Well.fromFields( typeArg, Well.bcs.parse(data) ) }
 ...
 static fromJSONField<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, field: any ): Well<ToPhantomTypeArgument<T>> { return Well.reified( typeArg, ).new( { id: decodeFromJSONField(UID.reified(), field.id), sharedPool: decodeFromJSONField(Balance.reified(typeArg), field.sharedPool), reserve: decodeFromJSONField(Balance.reified(typeArg), field.reserve), staked: decodeFromJSONField(Balance.reified(reified.phantom(BKT.reified())), field.staked), totalWeight: decodeFromJSONField("u64", field.totalWeight), currentS: decodeFromJSONField("u128", field.currentS) } ) }

 static fromJSON<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, json: Record<string, any> ): Well<ToPhantomTypeArgument<T>> { if (json.$typeName !== Well.$typeName) { throw new Error("not a WithTwoGenerics json object") }; assertReifiedTypeArgsMatch( composeSuiType(Well.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg], )

 return Well.fromJSONField( typeArg, json, ) }

 static fromSuiParsedData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, content: SuiParsedData ): Well<ToPhantomTypeArgument<T>> { if (content.dataType !== "moveObject") { throw new Error("not an object"); } if (!isWell(content.type)) { throw new Error(`object at ${(content.fields as any).id} is not a Well object`); } return Well.fromFieldsWithTypes( typeArg, content ); }

 static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: SuiObjectData ): Well<ToPhantomTypeArgument<T>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isWell(data.bcs.type)) { throw new Error(`object at is not a Well object`); }
...
export interface StakedBKTFields<T extends PhantomTypeArgument> { id: ToField<UID>; stakeAmount: ToField<"u64">; startS: ToField<"u128">; stakeWeight: ToField<"u64">; lockUntil: ToField<"u64"> }

export type StakedBKTReified<T extends PhantomTypeArgument> = Reified< StakedBKT<T>, StakedBKTFields<T> >;

export class StakedBKT<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::well::StakedBKT`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = StakedBKT.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::well::StakedBKT<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = StakedBKT.$isPhantom;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: StakedBKTFields<T>, ) { this.$fullTypeName = composeSuiType( StakedBKT.$typeName, ...typeArgs ) as `${typeof PKG_V1}::well::StakedBKT<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;
 ...
 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): StakedBKTReified<ToPhantomTypeArgument<T>> { return { typeName: StakedBKT.$typeName, fullTypeName: composeSuiType( StakedBKT.$typeName, ...[extractType(T)] ) as `${typeof PKG_V1}::well::StakedBKT<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: StakedBKT.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => StakedBKT.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => StakedBKT.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => StakedBKT.fromBcs( T, data, ), bcs: StakedBKT.bcs, fromJSONField: (field: any) => StakedBKT.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => StakedBKT.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => StakedBKT.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => StakedBKT.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => StakedBKT.fetch( client, T, id, ), new: ( fields: StakedBKTFields<ToPhantomTypeArgument<T>>, ) => { return new StakedBKT( [extractType(T)], fields ) }, kind: "StructClassReified", } }

 static get r() { return StakedBKT.reified }

 static phantom<T extends PhantomReified<PhantomTypeArgument>>( T: T ): PhantomReified<ToTypeStr<StakedBKT<ToPhantomTypeArgument<T>>>> { return phantom(StakedBKT.reified( T )); } static get p() { return StakedBKT.phantom }
 ...
 static fromFields<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, fields: Record<string, any> ): StakedBKT<ToPhantomTypeArgument<T>> { return StakedBKT.reified( typeArg, ).new( { id: decodeFromFields(UID.reified(), fields.id), stakeAmount: decodeFromFields("u64", fields.stake_amount), startS: decodeFromFields("u128", fields.start_s), stakeWeight: decodeFromFields("u64", fields.stake_weight), lockUntil: decodeFromFields("u64", fields.lock_until) } ) }

 static fromFieldsWithTypes<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, item: FieldsWithTypes ): StakedBKT<ToPhantomTypeArgument<T>> { if (!isStakedBKT(item.type)) { throw new Error("not a StakedBKT type");
 ...
 static fromBcs<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: Uint8Array ): StakedBKT<ToPhantomTypeArgument<T>> { return StakedBKT.fromFields( typeArg, StakedBKT.bcs.parse(data) ) }
 ...
 static fromJSONField<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, field: any ): StakedBKT<ToPhantomTypeArgument<T>> { return StakedBKT.reified( typeArg, ).new( { id: decodeFromJSONField(UID.reified(), field.id), stakeAmount: decodeFromJSONField("u64", field.stakeAmount), startS: decodeFromJSONField("u128", field.startS), stakeWeight: decodeFromJSONField("u64", field.stakeWeight), lockUntil: decodeFromJSONField("u64", field.lockUntil) } ) }

 static fromJSON<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, json: Record<string, any> ): StakedBKT<ToPhantomTypeArgument<T>> { if (json.$typeName !== StakedBKT.$typeName) { throw new Error("not a WithTwoGenerics json object") }; assertReifiedTypeArgsMatch( composeSuiType(StakedBKT.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg], )

 return StakedBKT.fromJSONField( typeArg, json, ) }

 static fromSuiParsedData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, content: SuiParsedData ): StakedBKT<ToPhantomTypeArgument<T>> { if (content.dataType !== "moveObject") { throw new Error("not an object"); } if (!isStakedBKT(content.type)) { throw new Error(`object at ${(content.fields as any).id} is not a StakedBKT object`); } return StakedBKT.fromFieldsWithTypes( typeArg, content ); }

 static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: SuiObjectData ): StakedBKT<ToPhantomTypeArgument<T>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isStakedBKT(data.bcs.type)) { throw new Error(`object at is not a StakedBKT object`); }
