...
export interface FactoryFields<YourStable extends PhantomTypeArgument> { id: ToField<UID>; decimals: ToField<"u8">; beneficiary: ToField<VecSet<"address">>; underlyingBalance: ToField<Balance<ToPhantom<ST_SBUCK>>>; basicSupply: ToField<LimitedSupply>; extensionSupplies: ToField<VecMap<TypeName, LimitedSupply>> }
...
export class Factory<YourStable extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 readonly id: ToField<UID>; readonly decimals: ToField<"u8">; readonly beneficiary: ToField<VecSet<"address">>; readonly underlyingBalance: ToField<Balance<ToPhantom<ST_SBUCK>>>; readonly basicSupply: ToField<LimitedSupply>; readonly extensionSupplies: ToField<VecMap<TypeName, LimitedSupply>>
 ...
 this.id = fields.id;; this.decimals = fields.decimals;; this.beneficiary = fields.beneficiary;; this.underlyingBalance = fields.underlyingBalance;; this.basicSupply = fields.basicSupply;; this.extensionSupplies = fields.extensionSupplies; }
 ...
 id: UID.bcs, decimals: bcs.u8(), beneficiary: VecSet.bcs(bcs.bytes(32).transform({ input: (val: string) => fromHEX(val), output: (val: Uint8Array) => toHEX(val), })), underlying_balance: Balance.bcs, basic_supply: LimitedSupply.bcs, extension_supplies: VecMap.bcs(TypeName.bcs, LimitedSupply.bcs)

}) };

 static fromFields<YourStable extends PhantomReified<PhantomTypeArgument>>( typeArg: YourStable, fields: Record<string, any> ): Factory<ToPhantomTypeArgument<YourStable>> { return Factory.reified( typeArg, ).new( { id: decodeFromFields(UID.reified(), fields.id), decimals: decodeFromFields("u8", fields.decimals), beneficiary: decodeFromFields(VecSet.reified("address"), fields.beneficiary), underlyingBalance: decodeFromFields(Balance.reified(reified.phantom(ST_SBUCK.reified())), fields.underlying_balance), basicSupply: decodeFromFields(LimitedSupply.reified(), fields.basic_supply), extensionSupplies: decodeFromFields(VecMap.reified(TypeName.reified(), LimitedSupply.reified()), fields.extension_supplies) } ) }
 ...
 id: this.id,decimals: this.decimals,beneficiary: this.beneficiary.toJSONField(),underlyingBalance: this.underlyingBalance.toJSONField(),basicSupply: this.basicSupply.toJSONField(),extensionSupplies: this.extensionSupplies.toJSONField(),

} }

 toJSON() { return { $typeName: this.$typeName, $typeArgs: this.$typeArgs, ...this.toJSONField() } }

 static fromJSONField<YourStable extends PhantomReified<PhantomTypeArgument>>( typeArg: YourStable, field: any ): Factory<ToPhantomTypeArgument<YourStable>> { return Factory.reified( typeArg, ).new( { id: decodeFromJSONField(UID.reified(), field.id), decimals: decodeFromJSONField("u8", field.decimals), beneficiary: decodeFromJSONField(VecSet.reified("address"), field.beneficiary), underlyingBalance: decodeFromJSONField(Balance.reified(reified.phantom(ST_SBUCK.reified())), field.underlyingBalance), basicSupply: decodeFromJSONField(LimitedSupply.reified(), field.basicSupply), extensionSupplies: decodeFromJSONField(VecMap.reified(TypeName.reified(), LimitedSupply.reified()), field.extensionSupplies) } ) }
