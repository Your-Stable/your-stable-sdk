...
export class LimitedSupply implements StructClass { __StructClass = true as const;
 ...
 static reified( ): LimitedSupplyReified { return { typeName: LimitedSupply.$typeName, fullTypeName: composeSuiType( LimitedSupply.$typeName, ...[] ) as `${typeof PKG_V1}::limited_supply::LimitedSupply`, typeArgs: [ ] as [], isPhantom: LimitedSupply.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => LimitedSupply.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => LimitedSupply.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => LimitedSupply.fromBcs( data, ), bcs: LimitedSupply.bcs, fromJSONField: (field: any) => LimitedSupply.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => LimitedSupply.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => LimitedSupply.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => LimitedSupply.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => LimitedSupply.fetch( client, id, ), new: ( fields: LimitedSupplyFields, ) => { return new LimitedSupply( [], fields ) }, kind: "StructClassReified", } }
 ...
 static get bcs() { return bcs.struct("LimitedSupply", {
